<section>
  <header>
    <nav>
      <ul class="clearfix">
        <li><a href="<!--{$smarty.const.URL_DIR}-->contact/index.php"><img src="<!--{$TPL_URLPATH}-->img/nav_contact01_off.png" alt="メールフォーム" /></a></li>
        <li><a href=""><img src="<!--{$TPL_URLPATH}-->img/nav_contact02_on.png" alt="アドバイステレフォン" /></a></li>
        <li><a href="<!--{$smarty.const.URL_DIR}-->user_data/any_questions.php"><img src="<!--{$TPL_URLPATH}-->img/nav_contact03_off.png" alt="こんなことも聞けます！" /></a></li>
      </ul>
    </nav>
  </header>
...
-->
    ...
    <div>
      <a>
        <p class="adTelText2">
          体型のお悩みやデザインの好みをお聞きし、オーダーメイドのようにピッタリな一着を一緒に探させて頂きます。
        </p>
        <img src="<!--{$TPL_URLPATH}-->img/tel/adoteru-ruiko.png" alt="るんちゃんアドバイス"  style="width:100%;">
      </a>
    </div>
    <div>
      <p class="adTelText3">
