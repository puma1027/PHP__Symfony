...
/** 拡大画像横 */
define('LARGE_IMAGE_WIDTH', 660);
/** 拡大画像縦 */
define('LARGE_IMAGE_HEIGHT', 660);
/** 一覧画像横 */
define('SMALL_IMAGE_WIDTH', 180);
/** 一覧画像縦 */
define('SMALL_IMAGE_HEIGHT', 180);
/** 通常画像横 */
define('NORMAL_IMAGE_WIDTH', 330);
/** 通常画像縦 */
define('NORMAL_IMAGE_HEIGHT', 330);
/** 通常サブ画像横 */
define('NORMAL_SUBIMAGE_WIDTH', 260);
/** 通常サブ画像縦 */
define('NORMAL_SUBIMAGE_HEIGHT', 260);
/** 拡大サブ画像横 */
...
define('NO_IMAGE_REALFILE', HTML_REALDIR . "misc/blank.gif");
/** システム管理トップ */
...
define('DOWNLOAD_EXTENSION', "zip,lzh,jpg,jpeg,gif,png,mp3,pdf,csv,webp");
...
define('PENDING_ORDER_CANCEL_TIME', 1800);
...
/** SMARTYテンプレート */
define('TPL_DIR', HTTP_URL . USER_DIR . USER_PACKAGE_DIR . TEMPLATE_NAME . "/");
/** 画像がない場合に表示 */
define('NO_IMAGE_DIR', "misc/blank.gif");
/** 関連商品表示数 */
...
define('URL_SEARCH_TOP', ROOT_URLPATH . "admin/products/index.php");
/** フォトギャラリー用画像数（最大15点まで） */
define('PHOTO_GALLERY_IMAGE_NUM', "14");
/** フロント最大表示数 */
