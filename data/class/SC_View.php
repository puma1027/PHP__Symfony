...
class SC_View
{
    ...
    public function init()
    {
        ...
        $this->_smarty->registerPlugin('modifier', 'sfPreTax', array("SC_Utils_Ex", "sfPreTax"));
        ...
        //add bhm_20140320
        $this->_smarty->registerPlugin('modifier', 'sfPutBR', array("SC_Utils_Ex", "sfPutBR"));
		...
		// テンプレート変数を割り当て
        $this->assign("TPL_DIR", SC_Helper_PageLayout_Ex::getUserDir(SC_Display_Ex::detectDevice(), true));
