 ...
 * @version $Id$
 */
class LC_Page_Products_Review2 extends LC_Page_Ex {
    ...
    function init() {
        parent::init();
        $this->tpl_mainpage = 'products/review2.tpl';
            ...
            if (empty($this->arrErr)){
                ...
                if($flag == 0) {
                    ...
                    //レビュー書き込み完了ページへ
					 ...
					 SC_Response_Ex::sendRedirect($this->getLocation("./review_complete.php"));
