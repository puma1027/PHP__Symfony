...
class LC_Page_Sitemap extends LC_Page_Ex
{
    ...
    public function init()
    {
        ...
        $this->staticURL[] = HTTPS_URL . 'rss/' . DIR_INDEX_PATH;
    }
    ...
    public function getAllProducts()
    {
        ...
        foreach ($result as $row) {
            ...
            $arrPage['url'] = HTTPS_URL . 'products/list.php?category_id=' . $row['category_id'];
            $arrRet[] = $arrPage;
        }
    ...
    public function getAllDetail()
    {
        ...
        $sql = 'SELECT product_id, update_date FROM dtb_products WHERE del_flg<>1 AND status = 1 AND (haiki <> 1 OR haiki IS NULL)';
        $result = $objQuery->getAll($sql);
        ...
        foreach ($result as $row) {
            ...
            $arrPage['url'] = HTTPS_URL . substr(P_DETAIL_URLPATH, strlen(ROOT_URLPATH)) . $row['product_id'];
            $arrRet[] = $arrPage;
        }
