...
// 20200519 ishibashi 
    public function process()
    {
        ...
        case 'complete':
            ...
            //完了ページへ 
            SC_Response_Ex::sendRedirect($this->getLocation("./refusal_complete.php"));
            SC_Response_Ex::actionExit();
            break;
        }

	     $this->sendResponse();
         // 20200519 ishibashi action追記
         $this->action();
    }
    ...
    function mobileProcess() {
        ...
        if (isset($_POST['no'])) {
            SC_Response_Ex::sendRedirect($this->getLocation("./index.php"), true);
            SC_Response_Ex::actionExit();
            ...
            $objCustomer->EndSession();
            //完了ページへ
            SC_Response_Ex::sendRedirect($this->getLocation("./refusal_complete.php"), true);
            SC_Response_Ex::actionExit();
        }
    ...
    function lfIsValidMovement(&$objSiteSess) {
        // 確認ページからの遷移かどうかをチェックsfDispSiteError
        SC_Utils_Ex::sfIsPrePage($objSiteSess);
		//SC_Utils_Ex::sfDispSiteError($objSiteSess);
