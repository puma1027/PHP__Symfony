 ...
 * @version $Id$
 */
class LC_Page_Mypage_DateComplete extends LC_Page {
    ...
    function init() {
        ...
        $this->tpl_mainpage =  'mypage/date_complete.tpl';

        //$this->tpl_navi = TEMPLATE_REALDIR . 'mypage/navi.tpl';
        $this->tpl_navi = 'mypage/navi.tpl';

        $this->tpl_subtitle = "レンタル日程(完了ページ)";
        // ================ End ============
        $this->tpl_title = 'MYページ/レンタル日程(完了ページ)';
