...
class LC_Page_Admin_Design_MainEdit extends LC_Page_Admin_Ex
{
    ...
    public function getTplMainpage($device_type_id, $page_id, &$objLayout)
    {
        ...
        $filename = $templatePath . 'user_data/' . $arrPageData[0]['filename'] . '.tpl';//::B00145 Change 20140814
    ...
    public function doRegister(&$objFormParam, &$objLayout)
    {
        ...
        if ($objLayout->isEditablePage($arrParams['device_type_id'], $page_id)) {
            //::$tpl_path = $objLayout->getTemplatePath($arrParams['device_type_id'] /*Insert CHS_20140414*/, true/*End CHS_20140414*/) . $arrParams['filename'] . '.tpl';
            $tpl_path = $objLayout->getTemplatePath($arrParams['device_type_id']) . 'user_data/'. $arrParams['filename'] . '.tpl';//::B00145 Change 20140814
        } else {
            //::$tpl_path = $objLayout->getTemplatePath($arrParams['device_type_id'] /*Insert CHS_20140414*/, true/*End CHS_20140414*/) . $filename . '.tpl';
            $tpl_path = $objLayout->getTemplatePath($arrParams['device_type_id']) . 'user_data/'. $filename . '.tpl';//::B00145 Change 20140814
        }
