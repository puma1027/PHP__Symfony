...
class LC_Page_Admin_Products_ProductRank extends LC_Page_Admin_Ex
{
    ...
    public function lfGetProduct($category_id)
    {
        ...
        // 20200522 ishibashi category_idをT5に変更
        $where = 'del_flg = 0 AND T5.category_id = ?'; // 20200518 sg nakagawa mod
        ...
        $objQuery->setOrder('alldtl.rank DESC, alldtl.product_id DESC'); // 20200518 sg nakagawa mod
