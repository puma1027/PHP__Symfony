...
class LC_Page_Admin_Products_Category extends LC_Page_Admin_Ex
{
    ...
    public function init()
    {
        ...
        $this->arrGroup = array("A"=>"Aグループ", "B"=>"Bグループ", "C"=>"Cグループ", "D"=>"Dグループ");  //ADD KGS_20140313
    }
    ...
    public function initParam(&$objFormParam)
    {
        ...
        $objFormParam->addParam('グループ', 'group_id', INT_LEN, 'n', array('SPTAB_CHECK', 'MAX_LENGTH_CHECK'));  //ADD KGS_20140313
    }
    ...
    public function findCategoiesByParentCategoryId($parent_category_id)
    {
        ...
        $objQuery = SC_Query_Ex::getSingletonInstance();
        $col   = 'category_id, category_name, level, rank, group_id';  //REMARK KGS_20140313
    ...
    public function updateCategory($category_id, $arrCategory)
    {
        ...
        $arrCategory['group_id'] = $_POST['group_id'];     // ADD KGS_20140313                               
