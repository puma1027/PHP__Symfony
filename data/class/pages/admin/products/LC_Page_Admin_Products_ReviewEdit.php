...
class LC_Page_Admin_Products_ReviewEdit extends LC_Page_Admin_Products_Review
{
    ...
    public function init()
    {
        ...
        $this->tpl_subtitle = 'レビュー管理>レビュー編集';
    ...
    public function lfInitParam(&$objFormParam)
    {
        ...
        // {{ADD KGS_20140311  
        $objFormParam->addParam('利用シーン', 'use_scene1', INT_LEN, 'n', array('SELECT_CHECK'));                         
        $objFormParam->addParam('利用シーン', 'use_scene2', INT_LEN, 'n', array('SELECT_CHECK'));                         
        $objFormParam->addParam('利用シーン', 'use_scene3', INT_LEN, 'n', array('SELECT_CHECK'));                         
        // }}ADD KGS_20140311
    }
    ...
    public function lfGetReviewData($review_id)
    {
        ...
        // ADD KGS_20140311
        $select.=", use_scene1, use_scene2, use_scene3"; 
...
//        $objErr->doFunc(array("利用シーン", "use_scene1"), array("SELECT_CHECK"));  del bhm_20140318
