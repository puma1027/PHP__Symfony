...
class LC_Page_Admin_Customer_Edit extends LC_Page_Admin_Ex
{
    ...
    public function init()
    {
        ...
        $this->arrVisitRouteName = array("日テレ1分間の深イイ話から","NHK東京カワイイTVから","「結婚式の服装マナー」のページから","「結婚式二次会のマナー」のページから","「マタニティドレス」のページから","「レンタルドレス」で検索したら出てきた","知人・友人の紹介");//KHS Add 2014.3.10
    }
