...
define('PRODUCT_TYPE', STOLE_PRODUCT_TYPE);//::N00083 Change 20131201
define('ROOT_CATAGORY', '64');
 ...
 * @version $Id$
 */
class LC_Page_Admin_Products_Product_Stole extends LC_Page_Admin_Ex {
    ...
    function init() {
        parent::init();
        $this->tpl_mainpage = 'extension/products/product_stole.tpl';  
        $this->tpl_mainno = 'products';
        $this->tpl_subno = 'product_stole';          
        $this->tpl_subtitle = 'ストール・ボレロ ';
...
//======== 2012.04.13 RCHJ Add ========
        $this->arrImage = SC_Helper_DB_Ex::sfGetInspectImages(STOLE_INSPECT_IMAGE_TYPE);
//======== end =========
    }
...
// ======== end ============
        ...
        // 確認ページから完了ページへ
        case 'complete':
            $this->tpl_mainpage = 'extension/products/complete_stole.tpl';
          
            $this->arrForm['product_id'] = $this->lfRegistProduct($_POST);		// データ登録
            //$this->arrForm['product_id'] = 1;		// データ登録
...
// ================ end ===============
    ...
    function lfProductPage() {
        ...
        // カテゴリの読込
        list($this->arrCatVal, $this->arrCatOut) = $objDb->sfGetLevelCatList(false, 2, 64);
...
//    }
	...
	function lfRegistProduct($arrList){
        ...
        $checkArray = array("name", "status", /*R.K 2012/02/14*/"icon_flag","product_flag",
							...
							,"wear_comment_under2","main_comment_point","image_stole"
...
//        $objErr->doFunc(array("ブランド", "brand_id"), array("EXIST_CHECK"));
    ...
    function lfProductConfirmPage() {
        $this->tpl_mainpage = 'extension/products/confirm_stole.tpl';
        ...
        list($arrCatVal, $arrCatOut) = $objDb->sfGetLevelCatList(false, 2, 64);
    ...
    */
    ...
    function lfRegistProducExt($arrList,$product_id) {
        ...
        $checkArray = array("product_id", "figure_detail",  "bust_flg","waist_flg",
                            ...
                            "shoulders_length_flg", "sleeve_length_flg",
                            ...
                            "fastener_type","other_data","set_content","content_status","ninoude_mawari","ninoude_mawari_flg",
                            "arm_hole","arm_hole_flg","bow_length","bow_length_flg","cuff_flg");
        $arrList = SC_Utils_Ex::arrayDefineIndexes($arrList, $checkArray);
