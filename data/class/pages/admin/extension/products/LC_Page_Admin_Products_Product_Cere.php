 ...
 * @version $Id$
 */
class LC_Page_Admin_Products_Product_Cere extends LC_Page_Admin_Ex {
    ...
    function init() {
        parent::init();
        $this->tpl_mainpage = 'extension/products/product_cere.tpl';
        $this->tpl_mainno = 'products';
        $this->tpl_subno = 'product_cere';
        $this->tpl_subtitle = 'セレスーツ';
