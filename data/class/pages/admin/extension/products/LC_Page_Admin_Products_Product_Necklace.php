...
//::define('PRODUCT_TYPE', '6');
define('PRODUCT_TYPE', NECKLACE_PRODUCT_TYPE);//::N00083 Change 20131201
define('ROOT_CATAGORY', '63');
 ...
 * @version $Id$
 */
class LC_Page_Admin_Products_Product_Necklace extends LC_Page_Admin_Ex {
    ...
    function init() {
        parent::init();
        $this->tpl_mainpage = 'extension/products/product_necklace.tpl';
        
        $this->tpl_mainno = 'products';
        $this->tpl_subno = 'product_necklace';   
        $this->tpl_subtitle = '商品登録（ネックレス）';
...
//R.K　2012/02/14　追加終了
        ...
        //::N000183 Add 20140616
        //長さ
        $this->arrNECKLACE_LENGTH = array('3'=>'ロング','2'=>'ミディアム','1'=>'ショート');
        //::N000183 end 20140616
...
//======== 2012.04.13 RCHJ Add ========
        $this->arrImage = SC_Helper_DB_Ex::sfGetInspectImages(NECKLACE_INSPECT_IMAGE_TYPE);
//======== end =========
    }
...
// ======== end ============
        ...
        // 確認ページから完了ページへ
        case 'complete':
            $this->tpl_mainpage = 'extension/products/complete_necklace.tpl';
...
// ================ end ===============
    ...
    function lfProductPage() {
        ...
        // カテゴリの読込
        list($this->arrCatVal, $this->arrCatOut) = $objDb->sfGetLevelCatList(false, 2, 63);
...
//R.K　2012/02/14　追加終了
    ...
    function lfRegistProduct($arrList) {
        ...
        $checkArray = array("name", "status", /*R.K 2012/02/14*/"icon_flag","product_flag",
							...
							,"releaseday_id","brand_id","tag","main_comment_point","length_overall"
							,"image_necklace"
...
//        $objErr->doFunc(array("ブランド", "brand_id"), array("EXIST_CHECK"));
    ...
    function lfProductConfirmPage() {
        $this->tpl_mainpage = 'extension/products/confirm_necklace.tpl';
        ...
        list($arrCatVal, $arrCatOut) = $objDb->sfGetLevelCatList(false, 2, 63);
    ...
    */
    ...
    function lfRegistProducExt($arrList,$product_id) {
        ...
        $checkArray = array("product_id", "figure_detail",
                            ...
                            ,"necklace_length");//::N00183 Add 20140616
        $arrList = SC_Utils_Ex::arrayDefineIndexes($arrList, $checkArray);
        ...
        $sqlval['necklace_length'] = $arrList['necklace_length'];//::N00183 Add 20140616
