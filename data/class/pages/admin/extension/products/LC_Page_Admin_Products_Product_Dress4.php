...
define('PRODUCT_TYPE', DRESS4_PRODUCT_TYPE);//::N00083 Change 20131201
define('ROOT_CATAGORY', '148');
 ...
 * @version $Id$
 */
class LC_Page_Admin_Products_Product_Dress4 extends LC_Page_Admin_Ex {
    ...
    function init() {
        parent::init();
        $this->tpl_mainpage = 'extension/products/product_dress4.tpl';
        $this->tpl_mainno = 'products';
        $this->tpl_subno = 'product_dress4';
        $this->tpl_subtitle = 'ドレス４点セット';
...
// ======== end ============
        ...
        // 確認ページから完了ページへ
        case 'complete':
            $this->tpl_mainpage = 'extension/products/complete_dress4.tpl';
...
// ================ end ===============
    ...
    function lfProductPage() {
        ...
        // カテゴリの読込
        list($this->arrCatVal, $this->arrCatOut) = $objDb->sfGetLevelCatList(false, 2, 148);
...
//        $objErr->doFunc(array("バッグブランド", "bag_brand_id"), array("EXIST_CHECK"));
    ...
    function lfProductConfirmPage() {
        $this->tpl_mainpage = 'extension/products/confirm_dress4.tpl';
...
$arrBolero[]= $arrList["bolero_bodysize_flg"] ? $arrList["bolero_bodysize_flg"].":".$arrList["bolero_bodysize"]:"0".":".$arrList["bolero_bodysize"];// RCHJ Add 2013.02.08
    ...
    function lfGetBag(){
        ...
        $arrBag = array();
        foreach ($results as $result) {
            $arrBag[$result['bag_id']] = $result['bag_no'];
        }
        return $arrBag;
    }
