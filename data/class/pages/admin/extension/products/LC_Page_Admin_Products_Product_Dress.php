...
define('PRODUCT_TYPE', DRESS_PRODUCT_TYPE);//::N00083 Change 20131201
define('ROOT_CATAGORY', '44');
 ...
 * @version $Id$
 */
class LC_Page_Admin_Products_Product_Dress extends LC_Page_Admin_Ex {
    ...
    function init() {
        parent::init();
        $this->tpl_mainpage = 'extension/products/product_dress.tpl';        
        $this->tpl_mainno = 'products';
        $this->tpl_subno = 'product_dress';     
        $this->tpl_subtitle = 'ドレス';
...
//        $this->arrMPSC_EVENT = $masterData->getMasterData("mtb_products_search_category_event");
        ...
        //シルエットリスト
        $this->arrSILHOUETTE = array('3'=>'セパレート-ドレス','4'=>'セパレート-パンツ');
...
//::N00072 Add 20130807
                ...
                //$arrForm['recommended_staff_comment'] = $arrForm['recommended_staff_comment'];
                //$arrForm['coord_point_staff_comment'] = $arrForm['coord_point_staff_comment'];
                //$arrForm['mens_review_staff_comment'] = $arrForm['mens_review_staff_comment'];
//::N00072 end 20130807
...
// ======== end ============
        ...
        // 確認ページから完了ページへ
        case 'complete':
            $this->tpl_mainpage = 'extension/products/complete_dress.tpl';
...
// ================ end ===============
    ...
    function lfProductPage() {
        ...
        // カテゴリの読込
        list($this->arrCatVal, $this->arrCatOut) = $objDb->sfGetLevelCatList(false, 2, 44);
...
//::N00072 Add 20130902
        ...
        $arrRetParentFlg = $objQuery->select("product_id, parent_flg", "dtb_products", "product_id = ?", array($_POST['product_id']));

        // 2020.10.13 SG.Yamauchi add
        // $this->arrForm['parent_flg'] = ( isset( $this->arrForm['parent_flg'] ) === false ) ? 1 : $this->arrForm['parent_flg'];
        $this->parent_flg = ( $arrRetParentFlg[0]['parent_flg'] === '1' ) ? 1 : 0;
...
//							,"wear_comment_under2","main_comment_point","silhouette","funct", "image_dress"
...
//    }
    ...
    function lfProductConfirmPage() {
        $this->tpl_mainpage = 'extension/products/confirm_dress.tpl';
        ...
        list($arrCatVal, $arrCatOut) = $objDb->sfGetLevelCatList(false, 2, 44);
    ...
    */
    ...
    function lfRegistProducExt($arrList,$product_id) {
        ...
        $checkArray = array("product_id", "figure_detail", "figure_detail_kids", "bust_flg","waist_flg",
                            "hip_flg", "garment_length_flg", "shoulders_flg","ninoude_mawari_flg","arm_hole_flg","bow_length_flg",
                            "shoulders_length_flg", "sleeve_length_flg", "cuff_flg", "under_flg", "inseam_flg",
                            "bust", "waist", "hip", "garment_length",
                            "shoulders", "shoulders_length", "sleeve_length", "cuff", "inseam",
                            "under_text", "thickness_type", "important_points", "important_points_ids", 
        					//::"liner_type", "fastener_type","other_data","set_content","content_status");
        					"liner_type", "fastener_type","other_data","set_content","set_content4","content_status","bustcup",
                            "ninoude_mawari","arm_hole","bow_length");//::N00062 Add 20130531//::N00072 Add 20130807 bustcup
        $arrList = SC_Utils_Ex::arrayDefineIndexes($arrList, $checkArray);
