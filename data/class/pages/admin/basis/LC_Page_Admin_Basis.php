...
class LC_Page_Admin_Basis extends LC_Page_Admin_Ex
{
    ...
    public function lfInitParam(&$objFormParam, $post)
    {
        ...
        // その他
        //{{ ADD BHM_20100313 
        $objFormParam->addParam('消費税率', 'tax', PERCENTAGE_LEN, 'n', array('NUM_CHECK', 'MAX_LENGTH_CHECK'));     
        $objFormParam->addParam('課税規則', 'tax_rule', INT_LEN, 'n', array('EXIST_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));  
        //}} ADD BHM_20100313
