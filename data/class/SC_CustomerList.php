    ...
    public function __construct($array, $mode = '')
    {
        ...
        if ($mode == 'customer') {
            ...
            if (isset($this->arrSql['search_htmlmail'])) {
	            if ($this->arrSql['search_htmlmail'] != 3) {// Add MGN_20140307
                    ...
                    if (SC_Utils_Ex::sfIsInt($this->arrSql['search_htmlmail'])) {
                        ...
                        //　メルマガ購読拒否は省く
//                        $this->setWhere('mailmaga_flg <> 3'); // Delete MGN_20140310
                        $this->setWhere('(mailmaga_flg = 1 OR mailmaga_flg = 2)'); // Add MGN_20140310
                    }
				}// Add MGN_20140307
            }
        }
        ...
        if ($mode == 'customer') {
            if (isset($this->arrSql['search_mail_type'])) {
				if (isset($this->arrSql['search_htmlmail']) && $this->arrSql['search_htmlmail'] != 3) { // Add MGN_20140307
