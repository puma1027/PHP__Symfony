 ...
 * @version $Id$
 */
class LC_Page_Products_Smart_Search_Ex extends LC_Page_Products_List
{
    ...
    function init() {
    	...
    	if($this->device_type_id == DEVICE_TYPE_SMARTPHONE){
    		...
    		$this->arrPRODUCTLISTMAX = array(30 => '30件');
		...
		$this->arrSize = array(
        		//::"1"=>array(DRESS_PRODUCT_TYPE=>"66", DRESS3_PRODUCT_TYPE=>"105", DRESS4_PRODUCT_TYPE=>"155", ONEPIECE_PRODUCT_TYPE=>"134", ), //SS
        		//::"2"=>array(DRESS_PRODUCT_TYPE=>"67", DRESS3_PRODUCT_TYPE=>"104", DRESS4_PRODUCT_TYPE=>"154", ONEPIECE_PRODUCT_TYPE=>"133", ), //S
        		//::"3"=>array(DRESS_PRODUCT_TYPE=>"68", DRESS3_PRODUCT_TYPE=>"103", DRESS4_PRODUCT_TYPE=>"153", ONEPIECE_PRODUCT_TYPE=>"132", ), //M
        		//::"4"=>array(DRESS_PRODUCT_TYPE=>"69", DRESS3_PRODUCT_TYPE=>"102", DRESS4_PRODUCT_TYPE=>"152", ONEPIECE_PRODUCT_TYPE=>"131", ), //L
        		//::"5"=>array(DRESS_PRODUCT_TYPE=>"70", DRESS3_PRODUCT_TYPE=>"101", DRESS4_PRODUCT_TYPE=>"151", ONEPIECE_PRODUCT_TYPE=>"130", ), //LL
        		//::"6"=>array(DRESS_PRODUCT_TYPE=>"201", DRESS3_PRODUCT_TYPE=>"221", DRESS4_PRODUCT_TYPE=>"180", ONEPIECE_PRODUCT_TYPE=>"-1", ), //3L
				//::"7"=>array(DRESS_PRODUCT_TYPE=>"62", DRESS3_PRODUCT_TYPE=>"112", DRESS4_PRODUCT_TYPE=>"162", ONEPIECE_PRODUCT_TYPE=>"29", ), // マタニティOK
		...
		$this->arrFunction = array(
        		//::"2"=>array(DRESS_PRODUCT_TYPE=>"74", DRESS3_PRODUCT_TYPE=>"115", DRESS4_PRODUCT_TYPE=>"165", ONEPIECE_PRODUCT_TYPE=>"-1", ), // 大きめバストすっきり
        		//::"3"=>array(DRESS_PRODUCT_TYPE=>"73", DRESS3_PRODUCT_TYPE=>"114", DRESS4_PRODUCT_TYPE=>"164", ONEPIECE_PRODUCT_TYPE=>"-1", ), // ぽっこりお腹をカバー
        		//::"4"=>array(DRESS_PRODUCT_TYPE=>"76", DRESS3_PRODUCT_TYPE=>"113", DRESS4_PRODUCT_TYPE=>"163", ONEPIECE_PRODUCT_TYPE=>"-1", ), // 大きめヒップをカバー
        		//::"1"=>array(DRESS_PRODUCT_TYPE=>"61", DRESS3_PRODUCT_TYPE=>"116", DRESS4_PRODUCT_TYPE=>"166", ONEPIECE_PRODUCT_TYPE=>"150", ), // ぽっちゃり二の腕カバー
        		//::"6"=>array(DRESS_PRODUCT_TYPE=>"62", DRESS3_PRODUCT_TYPE=>"112", DRESS4_PRODUCT_TYPE=>"162", ONEPIECE_PRODUCT_TYPE=>"29", ), // マタニティOK
		...
		$this->arrOptionBack = array(
			 ...
			 /*"2"=>array(DRESS_PRODUCT_TYPE=>"", DRESS3_PRODUCT_TYPE=>"", DRESS4_PRODUCT_TYPE=>"", ONEPIECE_PRODUCT_TYPE=>"", ), //
			 "3"=>array(DRESS_PRODUCT_TYPE=>"", DRESS3_PRODUCT_TYPE=>"", DRESS4_PRODUCT_TYPE=>"", ONEPIECE_PRODUCT_TYPE=>"", ), //
			 "4"=>array(DRESS_PRODUCT_TYPE=>"", DRESS3_PRODUCT_TYPE=>"", DRESS4_PRODUCT_TYPE=>"", ONEPIECE_PRODUCT_TYPE=>"", ), //
			 "5"=>array(DRESS_PRODUCT_TYPE=>"", DRESS3_PRODUCT_TYPE=>"", DRESS4_PRODUCT_TYPE=>"", ONEPIECE_PRODUCT_TYPE=>"", ), //
			 "6"=>array(DRESS_PRODUCT_TYPE=>"", DRESS3_PRODUCT_TYPE=>"", DRESS4_PRODUCT_TYPE=>"", ONEPIECE_PRODUCT_TYPE=>"", ), //
			 "7"=>array(DRESS_PRODUCT_TYPE=>"", DRESS3_PRODUCT_TYPE=>"", DRESS4_PRODUCT_TYPE=>"", ONEPIECE_PRODUCT_TYPE=>"", ), //
			 "8"=>array(DRESS_PRODUCT_TYPE=>"", DRESS3_PRODUCT_TYPE=>"", DRESS4_PRODUCT_TYPE=>"", ONEPIECE_PRODUCT_TYPE=>"", ), //*/
		);

		$this->arrSilhouette = array(
			//::"1"=>array(DRESS_PRODUCT_TYPE=>"59", DRESS3_PRODUCT_TYPE=>"119", DRESS4_PRODUCT_TYPE=>"169", ONEPIECE_PRODUCT_TYPE=>"30", ), //　全身美ライン
			//::"2"=>array(DRESS_PRODUCT_TYPE=>"60", DRESS3_PRODUCT_TYPE=>"118", DRESS4_PRODUCT_TYPE=>"168", ONEPIECE_PRODUCT_TYPE=>"28", ), //　全身ふんわり
			//::"3"=>array(DRESS_PRODUCT_TYPE=>"75", DRESS3_PRODUCT_TYPE=>"117", DRESS4_PRODUCT_TYPE=>"167", ONEPIECE_PRODUCT_TYPE=>"-1", ), // ウエスト切り替え
			//::"4"=>array(DRESS_PRODUCT_TYPE=>"209", DRESS3_PRODUCT_TYPE=>"219", DRESS4_PRODUCT_TYPE=>"189", ONEPIECE_PRODUCT_TYPE=>"-1", ), // アンダーバスト切り替え
		...
		$this->arrCollar = array(
			//::"1"=>array(DRESS_PRODUCT_TYPE=>"203", DRESS3_PRODUCT_TYPE=>"216", DRESS4_PRODUCT_TYPE=>"184", ONEPIECE_PRODUCT_TYPE=>"223", ), //　Vネック
			//::"2"=>array(DRESS_PRODUCT_TYPE=>"202", DRESS3_PRODUCT_TYPE=>"215", DRESS4_PRODUCT_TYPE=>"185", ONEPIECE_PRODUCT_TYPE=>"224", ), //　スクェアネック
			//::"3"=>array(DRESS_PRODUCT_TYPE=>"204", DRESS3_PRODUCT_TYPE=>"217", DRESS4_PRODUCT_TYPE=>"186", ONEPIECE_PRODUCT_TYPE=>"225", ), // ハイネック(ONEPIECE_PRODUCT_TYPE: タートルネック )
			//::"4"=>array(DRESS_PRODUCT_TYPE=>"205", DRESS3_PRODUCT_TYPE=>"218", DRESS4_PRODUCT_TYPE=>"187", ONEPIECE_PRODUCT_TYPE=>"222", ), // その他
	...
	// パンくずタグ生成　下記を追記 
		...
		$top_name = 'レンタルドレスワンピの魔法トップページ';
	    if($cate_name == 'dress') {
	        $TopicPath = '<a href="'.HTTPS_URL.'">'.$top_name.'</a> &gt; ドレス単品、セットドレス';
	    } elseif($cate_name == 1){
	        $TopicPath = '<a href="'.HTTPS_URL.'">'.$top_name.'</a> &gt; ワンピース';
	    } elseif($cate_name == 64){
	        $TopicPath = '<a href="'.HTTPS_URL.'">'.$top_name.'</a> &gt; 羽織物';
	    } elseif($cate_name == 231){
	        $TopicPath = '<a href="'.HTTPS_URL.'">'.$top_name.'</a> &gt; バッグ';
	    } elseif($cate_name == 63){
	        $TopicPath = '<a href="'.HTTPS_URL.'">'.$top_name.'</a> &gt; ネックレス';
	    } elseif($cate_name == 65){
	        $TopicPath = '<a href="'.HTTPS_URL.'">'.$top_name.'</a> &gt; その他小物';
	    } elseif($cate_name == 367){
	        $TopicPath = '<a href="'.HTTPS_URL.'">'.$top_name.'</a> &gt; セレモニースーツセット';
	    } elseif(strpos($product_code,'15-') !== FALSE){
	        $TopicPath = '<a href="'.HTTPS_URL.'">'.$top_name.'</a> &gt; コート・ガウン';
	    } else {
	    	$TopicPath = '<a href="'.HTTPS_URL.'">'.$top_name.'</a> &gt; 商品を選ぶ';
	    }
...
//			if (!isset($_GET['kind2']))	$_GET['kind2'] = CATEGORY_DRESS;
		...
		// タイトル編集
		$this->tpl_subtitle = "";
		if ($_GET['mode'] == 'search' || $_GET['mode'] == 'category_search') {
			...
			switch ($arrCategory_id[0]){
				case CATEGORY_NECKLACE:
					$this->tpl_subtitle = "ネックレス";

					break;
				case CATEGORY_STOLE:
					$this->tpl_subtitle = "羽織物";

					break;
				case CATEGORY_OTHERS:
					$this->tpl_subtitle = "その他の小物";

					break;
				case CATEGORY_ONEPIECE:
					$this->tpl_subtitle = "ワンピース　3,980円";

					break;
				case CATEGORY_SNO:
					$this->tpl_subtitle = "羽織物・アクセサリー　490円";

					break;
				default:
					$this->tpl_subtitle = "ドレス系　5,980円～";
...
$this->tpl_mainpage =  'products/smart_search.tpl';
	...
	function mobileProcess() {
		...
		$this->arrSearch = $arrSearch;
		$this->tpl_mainpage = MOBILE_TEMPLATE_DIR . "products/smart_search.tpl";
	...
	function lfDispProductsList($category_id, $name, $disp_num, $orderby) {
        ...
        if(empty($this->tpl_date2)/* && $week == 3*/){
            $wend_day = $this->tpl_date1;
        }else{
            $wend_day =$this->tpl_date2;
        }
//::B00098 Add 20140618
$sql_zaiko_kakuninn = "";
if (!empty($wend_day)) {
...
EOF;
			...
			case CATEGORY_ALL:
				...
				// 商品コードで21-XXCMがつくものは除外、且つ21-0001CMは商品コードが特殊のため個別に指定
				$sql .= " and (product_code not like ?) ";
				$arr_val[] = '21-%CM';
				$sql .= " and (product_code not like ?) ";
				$arr_val[] = ' 21-0001CM';
...
/*//::N00190 Del 20140616
				...
				if(in_array(CATEGORY_NECKLACE, $arrCategory_id) && isset($_REQUEST[LEN])){
					$sql_temp1 .= " ( ";
					foreach ($_REQUEST[LEN] as $value) {
						...
						if($value == "002_143"){
							$sql_temp1 .= " (length_overall is NULL or  CAST(substring(length_overall from '([0-9]{1,3})($|～)') as float) <= 44) or";
						}else{
							$sql_temp2 = $this->arrLenNeck[$value]["from"]." and ".$this->arrLenNeck[$value]["to"];

							$sql_temp1 .= " ((CAST(substring(length_overall from '([0-9]{1,3})($|～)') as float) between ".$sql_temp2.") or";
							$sql_temp1 .= " (CAST(substring(length_overall from '[～・]([0-9]{1,3})') as float) between ".$sql_temp2.")) or";
						}
					}
					$sql_temp1 = rtrim($sql_temp1, "or");
