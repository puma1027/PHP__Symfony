...
// {{{ requires
require_once(CLASS_REALDIR . "pages/admin/extension/products/LC_Page_Admin_Products_Product_Dress4.php");

/**
 * 商品登録 のページクラス(拡張).
 *
 * LC_Page_Admin_Products_Product_Dress3 をカスタマイズする場合はこのクラスを編集する.
 *
 * @package Page
 * @author EC-CUBE CO.,LTD.
 * @version $Id$
 */
class LC_Page_Admin_Products_Product_Dress4_Ex extends LC_Page_Admin_Products_Product_Dress4 {
...
//====== RCHJ Add ========
        ...
        $product_type = DRESS4_PRODUCT_TYPE; // レンタルドレス4点セット(LC_Page_Admin_Products.php: Line 369)
