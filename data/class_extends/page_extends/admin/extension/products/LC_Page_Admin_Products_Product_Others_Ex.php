...
// {{{ requires
require_once(CLASS_REALDIR . "pages/admin/extension/products/LC_Page_Admin_Products_Product_Others.php");
 ...
 * @version $Id$
 */
class LC_Page_Admin_Products_Product_Others_Ex extends LC_Page_Admin_Products_Product_Others {
...
// ======================= end =======================
        ...
        $objErr->doFunc(array("色", "colors", MTEXT_LEN), array("MAX_LENGTH_CHECK"));
        $objErr->doFunc(array("伸縮", "stretch", MTEXT_LEN), array("MAX_LENGTH_CHECK"));
        $objErr->doFunc(array("全長", "length_overall", MTEXT_LEN), array("MAX_LENGTH_CHECK"));
    ...
    function lfRegistProduct($arrList) {
        ...
        $checkArray = array("name", "status", "map_url", /*R.K 2012/02/14*/"icon_flag", "product_flag",// *UAssist
							...
							,"releaseday_id","brand_id","main_comment_point","length_overall","colors","stretch", "image_others"
...
//R.K　2012/02/14　追加終了
		...
		$sqlval['colors'] = $arrList['colors'];
		$sqlval['stretch'] = $arrList['stretch'];
        //::N00072 Add 20130807
...
//====== RCHJ Add ========
        ...
        $product_type = OTHERS_PRODUCT_TYPE; // その他小物を選ぶ(LC_Page_Admin_Products.php: Line 369)
        ...
        $sqlval["product_id"] = $product_id;
        $sqlval["product_type"] = $product_type;
        $sqlval["image_id5"] = $arrList["image_others"];
        $sqlval["creator_id"] = $_SESSION["member_id"];
        $sqlval["create_date"] = "Now()";
        $sqlval["update_date"] = "Now()";
