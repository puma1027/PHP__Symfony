...
// {{{ requires
require_once(CLASS_PATH . "pages/admin/extension/products/LC_Page_Admin_Products_Product_Dress3.php");
 ...
 * @version $Id$
 */
class LC_Page_Admin_Products_Product_Dress3_Ex extends LC_Page_Admin_Products_Product_Dress3 {
...
// ======================= end =======================
    ...
    function lfRegistProduct($arrList) {
        ...
        $checkArray = array("name", "status", "map_url", /*R.K 2012/02/14*/"icon_flag","funct_flag","silhouette_flag", "product_flag",// *UAssist
							...
							,"wear_comment_under2","main_comment_point","silhouette","funct", "image_dress", "image_stole", "image_necklace", "model_body_length"
...
//====== RCHJ Add ========
        ...
        $product_type = DRESS3_PRODUCT_TYPE; // レンタルドレス3点セット(LC_Page_Admin_Products.php: Line 369)
