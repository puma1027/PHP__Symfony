...
// {{{ requires
require_once(CLASS_REALDIR . "pages/admin/extension/products/LC_Page_Admin_Products_Product_Dress.php");


/**
 * 商品登録 のページクラス(拡張).
 *
 * LC_Page_Admin_Products_Product_Dress をカスタマイズする場合はこのクラスを編集する.
 *
 * @package Page
 * @author EC-CUBE CO.,LTD.
 * @version $Id$
 */
class LC_Page_Admin_Products_Product_Dress_Ex extends LC_Page_Admin_Products_Product_Dress {
...
// ======================= end =======================
    ...
    function lfRegistProduct($arrList) {
        ...
        $checkArray = array("name", "status", "map_url", /*R.K 2012/02/14*/"icon_flag","funct_flag","silhouette_flag", "product_flag",// *UAssist
                            ...
                            ,"mpsc_age","mpsc_event","mpsc_size","mpsc_complex","mpsc_worry","parent_flg"
...
//R.K　2012/02/14　追加終了
        ...
        if ( (int)$arrList['parent_flg'] === 0 ){
           //$sqlval['parent_product_id'] = $arrList['parent_product_id'];
            $sqlval['parent_flg'] = 0;
            $this->arrForm['parent_flg'] = 0;
        }else{
            $this->arrForm['parent_flg'] = 1;
        }
...
//====== RCHJ Add ========
        ...
        $product_type = DRESS_PRODUCT_TYPE; // レンタルドレスを選ぶ (LC_Page_Admin_Products.php: Line 369)
