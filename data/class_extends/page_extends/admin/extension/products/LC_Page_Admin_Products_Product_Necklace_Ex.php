...
// {{{ requires
require_once(CLASS_REALDIR . "pages/admin/extension/products/LC_Page_Admin_Products_Product_Necklace.php");
 ...
 * @version $Id$
 */
class LC_Page_Admin_Products_Product_Necklace_Ex extends LC_Page_Admin_Products_Product_Necklace {
...
// ======================= end =======================
    ...
    function lfRegistProduct($arrList) {
        ...
        $checkArray = array("name", "status", "map_url", /*R.K 2012/02/14*/"icon_flag", "product_flag",// *UAssist
							...
							,"releaseday_id","brand_id","main_comment_point","length_overall","image_necklace"
...
//R.K　2012/02/14　追加終了
        ...
        $sqlval2 = array();
        // UPDATEの実行
        $sqlval2['set_pcode_necklace'] = $arrList["product_code"];
        $where = "set_pcode_necklace = ?";
...
//====== RCHJ Add ========
        ...
        $product_type = NECKLACE_PRODUCT_TYPE; // ネックレスを選ぶ(LC_Page_Admin_Products.php: Line 369)
