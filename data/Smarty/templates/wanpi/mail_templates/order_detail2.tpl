...
発送日：<!--{$arrSubjectDate.deliv_date|default:"指定なし"}-->
お届け予定日：<!--{$arrOrder.deliv_date|default:"指定なし"}-->
<!--{if ($arrOrder.deliv_time == "20時～21時")}-->
	お届け時間：<!--{"19時～21時"|default:"指定なし"}-->
<!--{else}-->
	お届け時間：<!--{$arrOrder.deliv_time|default:"指定なし"}-->
<!--{/if}-->
ご利用日：<!--{$arrSubjectDate.use_date|default:"指定なし"}-->
ご返却日：<!--{$arrSubjectDate.return_date|default:"指定なし"}-->
その他ご連絡事項：<!--{$Message_tmp}-->
...
値引き ￥ <!--{$mail_discount|number_format|default:0}-->
