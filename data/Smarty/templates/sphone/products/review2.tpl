...
<div id="windowarea">
    ...
    <form name="form1" method="post" action="?">
        ...
        <input type="hidden" name="sex" id="woman" value="2" />
        ...
        <div class="btn_area">
                <p><input type="submit" value="確認ページへ" class="btn data-role-none" alt="確認ページへ" name="next" id="next" /></p>
            </div>
    </form>
</div>
