<div class="left pc_show">
    ...
    <form method="get" action="<!--{$smarty.const.ROOT_URLPATH}-->products/list.php">
        ...
        <input id="kind_all" name="kind_all" type="hidden" value="all">
         ...
         <div class="ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield ui-body-f"><input type="text" data-type="search" name="name" id="search" value="" placeholder="例：11-1234" class="searchbox ui-input-text ui-body-f halfcharacter"><a href="#" class="ui-input-clear ui-btn ui-btn-up-f ui-btn-icon-notext ui-btn-corner-all ui-shadow ui-input-clear-hidden" title="clear text" data-theme="f"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">clear text</span><span class="ui-icon ui-icon-delete ui-icon-shadow"></span></span></a></div>
    </form>
            ...
            <div class="categorylistmenu">
                <div class="categorylist">
                    <ul class="categorylist__grp">
                      ...
                      <li class="categorylist__item"><a class="categorylist__link <!--{if $smarty.get.type[6] =='352'}-->categorylist__link--current<!--{/if}-->" href="<!--{$url_hairacce_list}-->">
                          <div class="categorylist__thumbs">
                      ...
                      <li class="categorylist__item"><a class="categorylist__link<!--{if $smarty.get.category_id === '' && $smarty.get.name === '82-'}--> categorylist__link--current<!--{/if}-->" href="<!--{$url_earrings_list}-->">
                          <div class="categorylist__thumbs">
