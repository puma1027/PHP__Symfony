...
<div id="wrapper">
	<header>
  	<nav>
    	<ul class="clearfix">
      	<li><a href="<!--{$smarty.const.HTTPS_URL|sfTrimURL}-->/ranking/index.php?type=review"><img src="<!--{$TPL_URLPATH}-->img/nav_rank01_off.png" alt="レビューの多い順" /></a></li>
        ...
        <li><a href="<!--{$smarty.const.HTTPS_URL|sfTrimURL}-->/ranking/index.php?type=reco"><img src="<!--{$TPL_URLPATH}-->img/nav_rank03_on.png" alt="スタッフのおすすめ順" /></a></li>
      </ul>
    </nav>
...
<!--{section name=cnt loop=$tpl_disp_max}-->
    ...
    <table>
      <tr>
        <td style="background-color:#FFFED5">
            <p><!--{$arrComment[0].best_products_recommend_comment_text}--></p>
        </td>
        <td>
              <img  src="<!--{$smarty.const.STAFF_IMAGE_URL}--><!--{$arrComment[0].staff_image|escape}-->" alt="<!--{$arrComment[0].staff_name}-->" width="92px" />
        </td>
      </tr>
    </table>
	<!--{/if}-->
