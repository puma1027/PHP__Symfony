                    ...
                    <div class="cartcartconfirmarea">
                        <!--{foreach from=$arrCartItems item=item}-->
                            ...
                            <div class="cartconfirmBox">
                                <img src="<!--{$smarty.const.ROOT_URLPATH}-->upload/save_image/<!--{$item.productsClass.main_list_image|sfNoImageMainList|h}-->" alt="<!--{$item.productsClass.name|h}-->" width="80" height="80" class="photoL" />
                                    ...
                                    <!--{foreach item=item from=$shippingItem.shipment_item}-->
                                        ...
                                        <div class="cartconfirmBox">
                                            <!--{if $item.productsClass.main_image|strlen >= 1}-->
                                                ...
                                                <img src="<!--{$smarty.const.ROOT_URLPATH}-->upload/save_image/<!--{$item.productsClass.main_list_image|sfNoImageMainList|h}-->" alt="<!--{$item.productsClass.name|h}-->" width="80" height="80" class="photoL" /></a>
                                            <!--{else}-->
                                                <img src="<!--{$smarty.const.ROOT_URLPATH}-->upload/save_image/<!--{$item.productsClass.main_list_image|sfNoImageMainList|h}-->" alt="<!--{$item.productsClass.name|h}-->" width="80" height="80" class="photoL" />
                                            <!--{/if}-->
                                            <div class="cartconfirmContents">
