...
//var send_date_index = 0;
        for(i=0; i< shipping_quantity ; i++){
                 //$('#sending_date\\['+i+'\\]').datepicker();
                $('#sending_date'+i).datepicker();
        }
    });
            ...
            <tr>
                ...
                <td>
                    ...
                    <!--{if $smarty.get.mode != 'add'}-->
                       <!-- 2014/04/18 <span class="attention">※ <!--{$arrORDERSTATUS[$smarty.const.ORDER_CANCEL]}-->に変更時には、在庫数を手動で戻してください。</span>-->
                    <!--{/if}-->
                </td>
            </tr>
            <tr>
...
<!--KHS ADD 2014.3.13-->
            <tr>
                <th>同梱注文番号</th>
                <td >
                	<!--{if $arrForm.include_orderid.value eq ""}-->
なし
                	<!--{else}-->
                		<a href="" onclick ="fnOpenWindow('<!--{$smarty.const.SITE_URL}-->ChlFApkIyT8eBiMz/order/edit.php?order_id=<!--{$arrForm.include_orderid.value}-->','edit','800','650'); return false;">
                			<!--{$arrForm.include_orderid.value|default:"なし"}-->
                		</a>
                	<!--{/if}-->
                </td>
            </tr>
<!--END-->
            ...
            *}-->
            ...
            <tr>
                ...
                <td>
                    ...
                    <!--{else}-->
                        (非会員)
                <!--{/if}--><font color="#f00000">（ポイントの修正は<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="return fnEdit('<!--{$arrForm.customer_id.value}-->');">顧客編集</a>から手動にてお願い致します。）</font>
        ...
        <!--{/if}-->
        <span class="red18"><!--{$arrErr.product_change}--></span><!--N00057 Change 20130530-->
        <span class="red12"><!--{$arrErr.product_add_cart}--></span>
        ...
        <table class="list order-edit-products">
            <tr>
                <th class="id">セット</th><!--//::N00083 Add 20131201-->
            ...
            <tr>
                <input type="hidden" name="set_check[<!--{$product_index}-->]" value="<!--{$arrForm.set_check.value[$product_index]}-->" id="set_check_<!--{$product_index}-->"><!--//::N00083 Add 20131201-->
                <!--//::N00083 Add 20131201-->
                <!--セット商品としてのヒモ付けを行う-->
                <td width="45" align="center" <!--{if $arrForm.set_pid.value[$product_index] != ""}-->bgcolor="#FDCB2F"<!--{/if}-->>
                  <input type="checkbox" name="set_check[<!--{$product_index}-->]" value="1" <!--{if $arrForm.set_pid.value[$product_index] != ""}-->checked<!--{/if}--> />
                </td>
                <!--//::N00083 end 20131201-->

                <!--商品コード-->
                <td class="center" <!--{if $arrForm.set_pid.value[$product_index] != ""}-->bgcolor="#FDCB2F"<!--{/if}-->>
                    ...
                    <!--{if $arrForm.set_pid.value[$product_index] != ""}--> <p class="red">(セット商品)</p> <!--{/if}-->
                </td>
                ...
                <input type="hidden" name="set_pid[<!--{$product_index}-->]" value="<!--{$arrForm.set_pid.value[$product_index]}-->" id="set_pid_<!--{$product_index}-->"><!--//::N00083 Add 20131201-->
                <input type="hidden" name="set_ptype[<!--{$product_index}-->]" value="<!--{$arrForm.set_ptype.value[$product_index]}-->" id="set_ptype_<!--{$product_index}-->"><!--//::N00083 Add 20131201-->
                </td>
                <!--単価-->
                <td class="center">
            ...
            <tr>
                <th colspan="6" class="column right">値引き</th>
                <td class="right">
            ...
            <tr>
                <th colspan="6" class="column right">あんしん保証</th>
                <td class="right">
                    <!--{assign var=key value="relief_value"}-->
                    <span class="attention"><!--{$arrErr[$key]}--></span>
                    <input type="text" name="<!--{$key}-->" value="<!--{$arrForm[$key].value|h}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" size="5" class="box6" />
                    円
                </td>
        ...
        <!--{foreach name=shipping from=$arrAllShipping item=arrShipping key=shipping_index}-->
            ...
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="<!--{$key}-->[<!--{$shipping_index}-->]" style="<!--{$arrErr[$key][$shipping_index]|sfGetErrorColor}-->">
                            ...
                            <!--{html_options options=$arrDelivTime selected=$arrShipping[$key]|default:0}-->
                        </select>
                    </td>
                </tr>
                <!-- KHS Add 2014.3.16-->
                <tr >
                    <th>▼発送日指定</th>
                    <td >
                        <!--{assign var=key value="sending_date"}-->
                        <input type="text" name="<!--{$key}-->[<!--{$shipping_index}-->]" id="<!--{$key}--><!--{$shipping_index}-->" value="<!--{$arrShipping[$key]|h}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key][$shipping_index]|sfGetErrorColor}-->" size="15" class="box15" readonly="readonly"/>
                        <span class="attention"><!--{$arrErr[$key][$shipping_index]}--></span>
                    </td>
                </tr>
                <!-- end -->
        ...
        <table class="form">
            <tr>
                ...
                <td>
                    ...
                    <span class="attention"><!--{$arrErr[$key]}--></span>
                    <select name="<!--{$key}-->">
                        <!--{html_options options=$arrDeliv selected=$arrForm[$key].value|default:5}-->
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <span class="attention"><!--{$arrErr[$key]}--></span>
                    <select name="<!--{$key}-->" id="<!--{$key}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" onchange="eccube.setModeAndSubmit('payment','anchor_key','deliv');">
