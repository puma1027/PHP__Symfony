...
<script type="text/javascript">//<![CDATA[
    ...
    function func_submit(product_id, class_name1, class_name2) {
		...
		var category_id=document.getElementById('sel_search_category_id').value;
...
<input type="submit" style="visibility:hidden; position:absolute; left:0px; top:0px; z-index:-10;">
    ...
    <table class="form">
        ...
        <tr>
            <th>カテゴリ</th>
            <td>
                <select name="search_category_id" id="sel_search_category_id">
        ...
        <!--{section name=cnt loop=$arrProducts}-->
            <!--{assign var=id value=$arrProducts[cnt].product_id}-->
                ...
                <tr style="background:<!--{$arrPRODUCTSTATUS_COLOR[$status]}-->;">
                    <td class="center">
<!--KHS ADD SITE_URL resize_image.php?image 2014.3.14-->
                        <img src="<!--{$smarty.const.SITE_URL}-->resize_image.php?image=<!--{$arrProducts[cnt].main_list_image|sfNoImageMainList|h}-->" style="max-width: 65px;max-height: 65;" alt="<!--{$arrRecommend[$recommend_no].name|h}-->" />
                    </td>
                    <td>
