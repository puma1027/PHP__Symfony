...
<!--▼CONTENTS-->
<form id="mail_photo_view" name="mail_photo_view">
<table width="556" border="0" cellspacing="0" cellpadding="0" summary=" ">
	<tr><td height="15"></td></tr>
	<tr>
		<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/error_top.jpg" width="672" height="14" alt=""></td>
	</tr>
	<tr>
		<td background="<!--{$TPL_DIR}-->img/contents/main_left.jpg"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="14" height="1" alt=""></td>
		<td bgcolor="#cccccc">
		<table width="640" border="0" cellspacing="0" cellpadding="0" summary=" " bgcolor="#cccccc">
			<tr>
	...
	<tr>
		<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/error_bottom.jpg" width="672" height="14" alt=""></td>
	</tr>
