...
function lfPopwinSubmit(formName) {
    eccube.openWindow('about:blank','pdf','1000','600');
    ...
    <table class="form">
        ...
        <tr>
            ...
            <td><!--{if $arrErr.year}--><span class="attention"><!--{$arrErr.year}--></span><!--{/if}-->
                ...
                <select name="month">
                <!--{html_options options=$arrMonth selected=$arrForm.month|ltrim:'0'}-->
                </select>月
                <select name="day">
                <!--{html_options options=$arrDay selected=$arrForm.day|ltrim:'0'}-->
                </select>日
            </td>
        </tr>
        <tr>
