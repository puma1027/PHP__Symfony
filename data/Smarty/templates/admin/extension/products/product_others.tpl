            ...
            <input type="checkbox" name="stock_unlimited" value="1" <!--{if $arrForm.stock_unlimited == "1"}-->checked<!--{/if}--> onclick="fnCheckStockLimit('<!--{$smarty.const.DISABLED_RGB}-->');"/>無制限
                                    ...
                                    <tr>
                                       <th><!--{$smarty.const.SALE_PRICE_TITLE}--><span class="attention"> *</span></th>
                                        ...
                                        <input type="radio" name="price02_flag" value="467" <!--{if $arrForm.price02=="" || $arrForm.price02 == "467"}-->checked<!--{/if}-->>467（税込 490）円<br>
                                        <input type="radio" name="price02_flag" value="1419" <!--{if $arrForm.price02 == "1419"}-->checked<!--{/if}-->>1419（税込 1490）円<br>
                                        <input type="radio" name="price02_flag" value="1895" <!--{if $arrForm.price02 == "1895"}-->checked<!--{/if}-->>1895（税込 1990）円<br>
                                        <input type="radio" name="price02_flag" value="-1" <!--{if $arrForm.price02!="" && $arrForm.price02 != "467" && $arrForm.price02 != "1419" && $arrForm.price02 != "1895"}-->checked<!--{/if}-->><input type="text" name="price02" value="<!--{$arrForm.price02|escape}-->" size="6" class="box6" maxlength="<!--{$smarty.const.PRICE_LEN}-->" style="<!--{if $arrErr.price02 != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->"/>円<span class="red10"> （半角数字で入力）</span></td>
                                    </tr>
                                    <!--{/if}-->
                                    <tr>
...
<tr>
	<th>検品画像タイプ</th>
	<td>
		<span class="attention"> <!--{$arrErr.image_others}--> </span>
		その他小物
		<select id="image_others" name="image_others" style="<!--{$arrErr.image_others|sfGetErrorColor}-->">
			<option value="">選択してください</option>
			<!--{html_options options=$arrImage selected=$arrForm.image_others}-->
		</select>
	</td>
</tr>
                                     <tr>
                       ...
                       <select name="category_id_unselect[]" id="category_id_unselect" onchange="" size="10" style="height: 120px; min-width: 200px;" multiple="multiple">
                        <!--{html_options values=$arrCatVal output=$arrCatOut selected=$arrForm.category_id}-->
                                    ...
                                    <tr>
                                        <th>色</th>
                                        <td>
                                        <span class="attention"><!--{$arrErr.colors}--></span>
                                        <input type="text" name="colors" value="<!--{$arrForm.colors|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" size="40" class="box40" style="<!--{$arrErr.colors|sfGetErrorColor}-->" /><span class="attention"> （上限<!--{$smarty.const.STEXT_LEN}-->文字）</span><br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>素材</th>
                                        ...
                                        <input type="text" name="item_materrial" value="<!--{$arrForm.item_materrial|escape|default:'ポリエステル100％'}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" size="40" class="box40" style="<!--{$arrErr.item_materrial|sfGetErrorColor}-->" /><span class="attention"> （上限<!--{$smarty.const.STEXT_LEN}-->文字）</span><br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>伸縮</th>
                                        <td>
                                        <span class="attention"><!--{$arrErr.stretch}--></span>
                                        <input type="text" name="stretch" value="<!--{$arrForm.stretch|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" size="40" class="box40" style="<!--{$arrErr.stretch|sfGetErrorColor}-->" /><span class="attention"> （上限<!--{$smarty.const.STEXT_LEN}-->文字）</span><br />
                                        </td>
                                    </tr>
                                    <tr>
                                       <th>留め具</th>
...
*}-->
                                    <tr>
          <th>小物カラー<span class="attention"> *</span></th><!--//::N00031 Change 20130402-->
                                        <td>
    ...
    <div id="tab2">
      <table>
          ...
          <td colspan="4">
            ...
            <input type="text" name="length_overall" value="<!--{$arrForm.length_overall|escape}-->" size="60" class="box60" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" style="<!--{$arrErr.length_overall|sfGetErrorColor}-->"/><br>
          </td>
        </tr>
    </table>  
