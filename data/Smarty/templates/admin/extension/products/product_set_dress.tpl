...
<style type="text/css">
.tabrow {    text-align: left;    float: right;    height: 60px;    margin-top: -10px;}
.tabrow li {    list-style: none;    width: 120px;    border: solid 2px #FFFFFF;    display: inline-block;}
.tabrow input[type=radio] {    display: none;}
.tabrow .normal_tab_color {    display: block;    cursor :pointer;    line-height: 20px;    background-color: #999999;    color: #ffffff;    margin-left: 2px;    padding:7px;}
.tabrow .attention_tab_color {    display: block;    cursor: pointer;    line-height: 20px;    background-color: #FF0000;    color: #ffffff;    margin-left: 2px;    padding:7px;}
.tabrow label:hover {    background-color: #D8A800;    color: #000000;}
.tabrow input[type=radio]:checked + label {    background-color: #ffffff;    color: #000000;}
.tabs .contents {    display: none;    position: absolute;    top:45px;    left: 0;}
.tabrow input[type=radio]:checked + label + .contents{display: block;}
/*サイズタブ切り替え*/
.size_tab ul{display:table; width:100%;}
.size_tab_title {border-top:solid 1px #ccc;}
.size_tab li{display: table-cell; border-bottom: solid 1px #ccc; border-left: solid 1px #ccc; width: 8.3%; padding: 10px; margin:0;}
.size_tab li:last-child{border-right:solid 1px #ccc;}
/*タブのスタイル*/
.tab_item {  width: calc(100%/6);  height: 40px;  border-bottom: 3px solid #21618C;  background-color: #d9d9d9;  line-height: 40px;  font-size: 14px;  text-align: center;  color: #565656;  display: block;  float: left;  text-align: center;  font-weight: bold;  transition: all 0.2s ease;}
...
/*選択されているタブのスタイルを変える*/
.size_tab input:checked + .tab_item {background-color: #21618C; color: #fff;}
</style>
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            ...
            <!--//::B00072 Change 20140429-->
            <input type="radio" name="price02_flag" value="5093" <!--{if $arrForm.price02=="" || $arrForm.price02 == "5093"}-->checked<!--{/if}-->>5093（税込 5980）円<br>
            <input type="radio" name="price02_flag" value="-1" <!--{if $arrForm.price02!="" && $arrForm.price02 != "5093"}-->checked<!--{/if}-->><input type="text" name="price02" value="<!--{$arrForm.price02|escape}-->" size="6" class="box6" maxlength="<!--{$smarty.const.PRICE_LEN}-->" style="<!--{if $arrErr.price02 != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->"/>円<span class="red10"> （半角数字で入力）</span></td>
          <!--//::B00072 end 20140429-->
        </tr>
        <!--{/if}-->
        <tr>
        ...
        <!--//::N00078 Add 20130911-->
        <tr>
          <th rowspan="3">セット商品コード</th>
          <td>
            <span class="attention"><!--{$arrErr.set_pcode_stole}--></span>
            <label>羽織物&nbsp;&nbsp;&nbsp;</label>
            <select id="set_pcode_stole" name="set_pcode_stole" style="<!--{$arrErr.set_pcode_stole|sfGetErrorColor}-->" onchange="selectAll('category_id'); fnModeSubmit('set_stole', 'anchor_key', '<!--{$arrForm.set_pcode_stole}-->'); return false;">
              <option value="">選択してください</option>
              <!--{html_options options=$arrStole selected=$arrForm.set_pcode_stole}-->
            </select>
          </td>
        </tr>
        <tr>
          <td>
            ...
            <label>ネックレス</label>
            <select id="set_pcode_necklace" name="set_pcode_necklace" style="<!--{$arrErr.set_pcode_necklace|sfGetErrorColor}-->" onchange="selectAll('category_id'); fnModeSubmit('set_necklace', 'anchor_key', '<!--{$arrForm.set_pcode_necklace}-->'); return false;">
              <option value="">選択してください</option>
              <!--{html_options options=$arrNecklace selected=$arrForm.set_pcode_necklace}-->
            </select>
          </td>
        </tr>
        <tr>
          <td>
            <span class="attention"><!--{$arrErr.set_pcode_bag}--></span>
            <label>バッグ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
            <select id="set_pcode_bag" name="set_pcode_bag" style="<!--{$arrErr.set_pcode_bag|sfGetErrorColor}-->" onchange="selectAll('category_id'); fnModeSubmit('set_bag', 'anchor_key', 'set_pcode_bag'); return false;">
              <option value="">選択してください</option>
              <!--{html_options options=$arrBag selected=$arrForm.set_pcode_bag}-->
            </select>&nbsp;
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <table border="0" cellspacing="0" cellpadding="0" >
              <span class="attention">(複数の付属品がある場合は、/(半角)で区切ってください。      例) ウエストリボン/背中の調節ひも/ボタン付リボン/付けえり)</span><!--//::N00062 Add 20130531-->
              <tr>
                <th class="right">ドレス
                </th>
                <td>
              ...
              <!--//::N00062 Add 20130531-->
              <tr>
                <th class="right"><label class="bgpink12">ピンク袋</label>
                </th>
                <td>
...
<h2>▼実寸サイズ</h2>
<p>＊ チェックした箇所が赤字で表示されます。</p>
<p>＊<span class="attention">キッズの場合は「子供」を選んで編集してください。</span>＊(B)は男の子。</p>
<p>＊「着丈」で「-」や「〜」<span class="attention">だけ</span>を入れないでください。</p>

<div class="size_tab">
  <input id="all" type="radio" name="tab_item" checked>
    <label class="tab_item" for="all">　大人　</label>
  <input id="programming" type="radio" name="tab_item">
    <label class="tab_item" for="programming">　子供　</label>

    <div class="tab_content" id="all_content">
      <div class="tab_content_description">
        <p class="c-txtsp">
        <ul class="center size_tab_title">
              <li>バスト</li>
              <li>アンダー</li><!--//::B00020 Change 20130326-->
              <li>ウエスト</li><!--//::B00020 Change 20130326-->
              <li>ヒップ</li><!--//::B00020 Change 20130326-->
              <li>着丈</li><!--//::B00020 Change 20130326-->
              <li>肩幅</li><!--//::B00020 Change 20130326-->
              <li>ゆき丈</li><!--// add 201807 -->
              <li>アームホール</li><!--// add 201807-->
              <li>二の腕周り</li><!--//::add 201807-->
              <li>袖の長さ</li><!--//::B00020 Change 20130326-->
              <li>袖口</li><!--//::B00020 Change 20130326-->
              <li>股下</li><!--//::B00020 Change 20190717-->
        </ul>
        </p>
      </div>
    </div>
    <div class="tab_content" id="programming_content">
      <div class="tab_content_description">
        <p class="c-txtsp">
          <ul class="center size_tab_title">
              <li>ー</li>
              <li>身幅</li><!--//::B00020 Change 20130326-->
              <li>パンツウエスト(B)</li><!--//::B00020 Change 20130326-->
              <li>パンツのヒップ(B)</li><!--//::B00020 Change 20130326-->
              <li>着丈</li><!--//::B00020 Change 20130326-->
              <li>肩幅</li><!--//::B00020 Change 20130326-->
              <li>ー</li><!--// add 201807 -->
              <li>アームホール</li><!--// add 201807-->
              <li>パンツ丈(B)</li><!--//::add 201807-->
              <li>そで丈</li><!--//::B00020 Change 20130326-->
              <li>もも周り(B)</li><!--//::B00020 Change 20130326-->
              <li>股下(B)</li><!--//::B00020 Change 20190717-->
          </ul>
        </p>
      </div>
    </div>
      <ul class="center">
          <li><p><input type="checkbox" name="bust_flg" value="1"<!--{if $arrForm.bust_flg == "1"}-->checked><!--{/if}--><br></p><!--//::B00020 Change 20130326-->
            <input type="text" name="bust" value="<!--{$arrForm.bust|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.bust|sfGetErrorColor}-->"/><br></li><!--//::B00020 Change 20130326-->
          <li><p><input type="checkbox" name="under_flg" value="1" <!--{if $arrForm.under_flg == "1"}-->checked><!--{/if}--><br></p><!--//::B00020 Change 20130326-->
            <input type="text" name="under_text" value="<!--{$arrForm.under_text|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.under_text|sfGetErrorColor}-->"/><br></li><!--//::B00020 Change 20130326-->
          <li><p><input type="checkbox" name="waist_flg" value="1" <!--{if $arrForm.waist_flg == "1"}-->checked><!--{/if}--><br></p><!--//::B00020 Change 20130326-->
            <input type="text" name="waist" value="<!--{$arrForm.waist|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.waist|sfGetErrorColor}-->"/><br></li><!--//::B00020 Change 20130326-->
          <li><p><input type="checkbox" name="hip_flg" value="1" <!--{if $arrForm.hip_flg == "1"}-->checked><!--{/if}--><br></p><!--//::B00020 Change 20130326-->
            <input type="text" name="hip" value="<!--{$arrForm.hip|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.hip|sfGetErrorColor}-->"/><br></li><!--//::B00020 Change 20130326-->
          <li><p><input type="checkbox" name="garment_length_flg" value="1" <!--{if $arrForm.garment_length_flg == "1"}-->checked><!--{/if}--><br></p><!--//::B00020 Change 20130326-->
            <input type="text" name="garment_length" value="<!--{$arrForm.garment_length|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.garment_length|sfGetErrorColor}-->"/><br></li><!--//::B00020 Change 20130326-->
          <li><p><input type="checkbox" name="shoulders_flg" value="1" <!--{if $arrForm.shoulders_flg == "1"}-->checked><!--{/if}--><br></p>
            <input type="text" name="shoulders" value="<!--{$arrForm.shoulders|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.shoulders|sfGetErrorColor}-->"/><br></li><!--//::B00020 Change 20130326-->
          <li><p><input type="checkbox" name="bow_length_flg" value="1" <!--{if $arrForm.bow_length_flg == "1"}-->checked><!--{/if}--><br></p><!--//::add 201807-->
            <input type="text" name="bow_length" value="<!--{$arrForm.bow_length|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.bow_length|sfGetErrorColor}-->"/><br></li><!--//::add 201807 ゆき丈-->
          <li><p><input type="checkbox" name="arm_hole_flg" value="1" <!--{if $arrForm.arm_hole_flg == "1"}-->checked><!--{/if}--><br></p><!--{*add 201807*}-->
            <input type="text" name="arm_hole" value="<!--{$arrForm.arm_hole|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.arm_hole|sfGetErrorColor}-->"/><br></li><!--{*201807 アームホール*}-->
          <li><p><input type="checkbox" name="ninoude_mawari_flg" value="1" <!--{if $arrForm.ninoude_mawari_flg == "1"}-->checked><!--{/if}--><br></p><!--{*add 201807*}-->
            <input type="text" name="ninoude_mawari" value="<!--{$arrForm.ninoude_mawari|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.ninoude_mawari|sfGetErrorColor}-->"/><br></li><!--{*201807 二の腕周り*}-->
          <li><p><input type="checkbox" name="sleeve_length_flg" value="1" <!--{if $arrForm.sleeve_length_flg == "1"}-->checked><!--{/if}--><br></p>
            <input type="text" name="sleeve_length" value="<!--{$arrForm.sleeve_length|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.sleeve_length|sfGetErrorColor}-->"/><br></li><!--//::B00020 Change 20130326-->
          <li><p><input type="checkbox" name="cuff_flg" value="1" <!--{if $arrForm.cuff_flg == "1"}-->checked><!--{/if}--><br></p><!--//::B00020 Change 20130326-->
            <input type="text" name="cuff" value="<!--{$arrForm.cuff|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.cuff|sfGetErrorColor}-->"/><br></li><!--//::B00020 Change 20130326-->
          <li><p><input type="checkbox" name="inseam_flg" value="1" <!--{if $arrForm.inseam_flg == "1"}-->checked><!--{/if}--><br></p><!--//::B00020 Change 20170717-->
            <input type="text" name="inseam" value="<!--{$arrForm.inseam|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.inseam|sfGetErrorColor}-->"/><br></li><!--//::B00020 Change 20190717-->
      </ul>
</div>
