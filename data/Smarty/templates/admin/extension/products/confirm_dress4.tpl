...
<div id="products" class="contents-main">
    ...
    <!-- End -->                  
            ...
            <table>
               ...
               <tr>
                    <td><!--{if $arrForm.bust_flg == "1"}--><span class="red"><!--{/if}--><!--{$arrForm.bust|nl2br}--><!--{if $arrForm.bust_flg == "1"}--></span><!--{/if}--></td><!--//::B00020 Change 20130326-->
                    <td><!--{if $arrForm.under_flg == "1"}--><span class="red"><!--{/if}--><!--{$arrForm.under_text|nl2br}--><!--{if $arrForm.under_flg == "1"}--></span><!--{/if}--></td><!--//::B00020 Change 20130326-->
                    <td><!--{if $arrForm.waist_flg == "1"}--><span class="red"><!--{/if}--><!--{$arrForm.waist|nl2br}--><!--{if $arrForm.waist_flg == "1"}--></span><!--{/if}--></td><!--//::B00020 Change 20130326-->
                    <td><!--{if $arrForm.hip_flg == "1"}--><span class="red"><!--{/if}--><!--{$arrForm.hip|nl2br}--><!--{if $arrForm.hip_flg == "1"}--></span><!--{/if}--></td><!--//::B00020 Change 20130326-->
                    <td><!--{if $arrForm.garment_length_flg == "1"}--><span class="red"><!--{/if}--><!--{$arrForm.garment_length|nl2br}--><!--{if $arrForm.garment_length_flg == "1"}--></span><!--{/if}--></td><!--//::B00020 Change 20130326-->
                    <td><!--{if $arrForm.shoulders_flg == "1"}--><span class="red"><!--{/if}--><!--{$arrForm.shoulders|nl2br}--><!--{if $arrForm.shoulders_flg == "1"}--></span><!--{/if}--></td><!--//::B00020 Change 20130326-->
                    <td><!--{if $arrForm.shoulders_length_flg == "1"}--><span class="red"><!--{/if}--><!--{$arrForm.shoulders_length|nl2br}--><!--{if $arrForm.shoulders_length_flg == "1"}--></span><!--{/if}--></td><!--//::B00020 Change 20130326-->
                    <td><!--{if $arrForm.sleeve_length_flg == "1"}--><span class="red"><!--{/if}--><!--{$arrForm.sleeve_length|nl2br}--><!--{if $arrForm.sleeve_length_flg == "1"}--></span><!--{/if}--></td><!--//::B00020 Change 20130326-->
                    <td><!--{if $arrForm.cuff_flg == "1"}--><span class="red"><!--{/if}--><!--{$arrForm.cuff|nl2br}--><!--{if $arrForm.cuff_flg == "1"}--></span><!--{/if}--></td><!--//::B00020 Change 20130326-->
                 </tr>
            </table>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><!--{if $arrForm.bolero_hip_flg == "1"}--><span class="red"><!--{/if}--><!--{$arrForm.bolero_hip|nl2br}--><!--{if $arrForm.bolero_hip_flg == "1"}--></span><!--{/if}--></td>
