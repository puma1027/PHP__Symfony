    ...
    <div id="tab1">
            ...
            <input type="checkbox" name="stock_unlimited" value="1" <!--{if $arrForm.stock_unlimited == "1"}-->checked<!--{/if}--> onclick="fnCheckStockLimit('<!--{$smarty.const.DISABLED_RGB}-->');"/>無制限
                                    ...
                                    <tr>
                                        ...
                                        <input type="radio" name="price02_flag" value="1895" <!--{if $arrForm.price02=="" || $arrForm.price02 == "1895"}-->checked<!--{/if}-->>1895（税込 1990）円<br>
                                        <input type="radio" name="price02_flag" value="-1" <!--{if $arrForm.price02!="" && $arrForm.price02 != "1895"}-->checked<!--{/if}-->><input type="text" name="price02" value="<!--{$arrForm.price02|escape}-->" size="6" class="box6" maxlength="<!--{$smarty.const.PRICE_LEN}-->" style="<!--{if $arrErr.price02 != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->"/>円<span class="red10"> （半角数字で入力）</span></td>
                                    </tr>
                                    <!--{/if}-->
                                    <tr>
...
<tr>
	...
	<td>
		...
		<select id="image_stole" name="image_stole" style="<!--{$arrErr.image_stole|sfGetErrorColor}-->">
			<option value="">選択してください</option>
			<!--{html_options options=$arrImage selected=$arrForm.image_stole}-->
		</select>
	</td>
</tr>
                                     <tr>
...
*}-->
        <tr>
          <th>ボレロカラー<span class="attention"> *</span></th>
          <td>
          ...
          <td colspan="11">
            <!--{html_checkboxes name="figure_detail" options=$arrFIGUREDETAIL separator="&nbsp;" selected=$arrForm.figure_detail}-->
                                    ...
                                    <tr>
                                        ...
                                        <th>ボレロ肩幅</th>
                                        <th>ゆき丈（kids:袖丈）</th>
                                        <th>ボレロアームホール</th><!--{*201808 add*}-->
                                        <th>二の腕周り</th><!--{*201807 add*}-->
                                        <th>ボレロ袖の長さ</th>
                                        <th>ボレロ袖口</th><!--{*201809 add*}-->
                                        <th>ストール幅</th>
                                        <th>ストール長さ</th>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="bow_length_flg" value="1"<!--{if $arrForm.bow_length_flg == "1"}-->checked><!--{/if}--><br></td>
                                        <td><input type="checkbox" name="arm_hole_flg" value="1" <!--{if $arrForm.arm_hole_flg == "1"}-->checked><!--{/if}--><br></td>
                                        <td><input type="checkbox" name="ninoude_mawari_flg" value="1" <!--{if $arrForm.ninoude_mawari_flg == "1"}-->checked><!--{/if}--><br></td><!--{*201807 add*}-->
                                        <td><input type="checkbox" name="garment_length_flg" value="1" <!--{if $arrForm.garment_length_flg == "1"}-->checked><!--{/if}--><br></td>
                                        <td><input type="checkbox" name="cuff_flg" value="1" <!--{if $arrForm.cuff_flg == "1"}-->checked><!--{/if}--><br></td><!--{*201809 add*}-->
                                    ...
                                    <tr>
                                        <td><input type="text" name="shoulders" value="<!--{$arrForm.shoulders|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.shoulders|sfGetErrorColor}-->"/><br></td>
                                        <td><input type="text" name="waist" value="<!--{$arrForm.waist|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.waist|sfGetErrorColor}-->"/><br></td>
                                        <td><input type="text" name="bust" value="<!--{$arrForm.bust|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.bust|sfGetErrorColor}-->"/><br></td>
                                        <td><input type="text" name="bow_length" value="<!--{$arrForm.bow_length|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.bow_length|sfGetErrorColor}-->"/><br></td>
                                        <td><input type="text" name="arm_hole" value="<!--{$arrForm.arm_hole|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.arm_hole|sfGetErrorColor}-->"/><br></td>
                                        <td><input type="text" name="ninoude_mawari" value="<!--{$arrForm.ninoude_mawari|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.ninoude_mawari|sfGetErrorColor}-->"/><br></td><!--{*201807 add*}-->
                                        <td><input type="text" name="garment_length" value="<!--{$arrForm.garment_length|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.garment_length|sfGetErrorColor}-->"/><br></td>
                                        <td><input type="text" name="cuff" value="<!--{$arrForm.cuff|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.cuff|sfGetErrorColor}-->"/><br></td><!--{* 201809 add *}-->
                                        <td><input type="text" name="shoulders_length" value="<!--{$arrForm.shoulders_length|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.shoulders_length|sfGetErrorColor}-->"/><br></td>
                                        <td><input type="text" name="sleeve_length" value="<!--{$arrForm.sleeve_length|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.sleeve_length|sfGetErrorColor}-->"/><br></td>
                                    </tr>
                                 </table>
                                <table>
                                    <tr>
