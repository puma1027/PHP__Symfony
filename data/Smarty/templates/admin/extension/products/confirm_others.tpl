...
<!-- 2012.04.13 RCHJ Add -->
								<tr>
                                    <th>検品画像タイプ</th>
                                    <td>
                                     	 その他小物：<!--{$arrImage[$arrForm.image_others]|escape}-->
                                    </td>
                                </tr>
<!-- end -->        
                                <tr>
                                ...
                                <tr>
                                    <th>色</th>
                                    <td>
                                    <!--{$arrForm.colors|escape|sfPutBR:$smarty.const.LINE_LIMIT_SIZE}-->
                                    </td>
                                </tr>
                                <tr>
                                    <th>伸縮</th>
                                    <td>
                                    <!--{$arrForm.stretch|escape|sfPutBR:$smarty.const.LINE_LIMIT_SIZE}-->
                                    </td>
                                </tr>
                                <tr>
                                    <th>留め具</th>
