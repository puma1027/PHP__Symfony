        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <label for="parent_flg">
                        ...
                        <input type="checkbox" id="parent_flg" name="parent_flg" value="1" <!--{if (int)$parent_flg === 1}-->checked="checked"<!--{/if}--> />親フラグ
                    </label>
                    <span class="attention">※ 枝番（11-XXXX-X）の場合はチェックを外します。</span>
                </td>
            </tr>
            <!--{*
            <tr id="parent_product_id_tr">
                <th>親ドレス選択<span class="attention"> *</span></th>
                <td>
            ...
            *}-->
            ...
            <tr>
                ...
                <input type="radio" name="price02_flag" value="5436" <!--{if $arrForm.price02=="" || $arrForm.price02 == "5436"}-->checked<!--{/if}-->>5436（税込 5980）円<br>
                <input type="radio" name="price02_flag" value="-1" checked><input type="text" name="price02" value="5537" size="6" class="box6" maxlength="<!--{$smarty.const.PRICE_LEN}-->" style="<!--{if $arrErr.price02 != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->"/>円<span class="red10"> （半角数字で入力）</span></td>
                <!--//::B00072 end 20140429-->
            </tr>
            <!--{/if}-->
            <tr>
            ...
            <tr>
                ...
                <input type="checkbox" name="sale_unlimited" value="1" <!--{if $arrForm.sale_unlimited == "1"}-->checked<!--{/if}--> onclick="eccube.checkSaleLimit('<!--{$smarty.const.DISABLED_RGB}-->');"/>無制限
                </td>
            </tr>
            <tr>
            ...
            <tr>
	            ...
	            <td>
		            ...
		            <select id="image_dress" name="image_dress" style="<!--{$arrErr.image_dress|sfGetErrorColor}-->">
			            <option value="">選択してください</option>
			            <!--{html_options options=$arrImage selected=$arrForm.image_dress}-->
		            </select>
	            </td>
            </tr> 
                 <tr>
               ...
               <tr>
                    ...
                    ドレス　　<input type="text" name="set_content" value="<!--{$arrForm.set_content|escape|default:'なし'}-->" size="60" class="box60" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" style="<!--{$arrErr.set_content|sfGetErrorColor}-->"/><br>
                ...
                <tr>
                    <th>youtube IDを入力します</th>
                    <td>
                    <span class="attention"><!--{$arrErr.funct}--></span>
                    <input type="text" name="funct_flag" value="<!--{$arrForm.funct_flag|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" size="40" class="box40" style="<!--{$arrErr.map_url|sfGetErrorColor}-->" />
                    </td>           
                </tr>
            </table>            
</div><!--//::tab1-->
...
<!--{*        <tr>
            <th>対応バストカップ</th>
            <td colspan="12"><!--{html_checkboxes name="bustcup" options=$arrBUSTCUP separator="&nbsp;" selected=$arrForm.bustcup}--></td>
        </tr>*}-->
    </table>
    ...
    <table>
        <tr class="center">
            ...
            <td><input type="checkbox" name="inseam_flg" value="1" <!--{if $arrForm.inseam_flg == "1"}-->checked><!--{/if}--><br></td>
        </tr>
        <tr class="center">
            ...
            <td><input type="text" name="inseam" value="<!--{$arrForm.inseam|escape}-->" size="7" class="box7" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.inseam|sfGetErrorColor}-->"/><br></td><!--//::B00020 Change 20190717-->
        </tr>
     </table>
...
<div id="tab4">
    <table>
        ...
        <tr>
            ...
            <td>
              <!--{html_checkboxes name="mpsc_event" options=$arrINPUT_EVENT selected=$arrForm.mpsc_event}-->
            </td>
        </tr>
        <tr>
            <th>
