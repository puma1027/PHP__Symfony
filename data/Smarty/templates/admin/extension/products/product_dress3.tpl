                               ...
                               <div id="tab1">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <input type="radio" name="price02_flag" value="8552" <!--{if $arrForm.price02=="" || $arrForm.price02 == "8552"}-->checked<!--{/if}-->>8552（税込 8980）円<br>
                                        <input type="radio" name="price02_flag" value="-1" <!--{if $arrForm.price02!="" && $arrForm.price02 != "8552"}-->checked<!--{/if}-->><input type="text" name="price02" value="<!--{$arrForm.price02|escape}-->" size="6" class="box6" maxlength="<!--{$smarty.const.PRICE_LEN}-->" style="<!--{if $arrErr.price02 != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->"/>円<span class="red10"> （半角数字で入力）</span></td>
                                    </tr>
                                    <!--{/if}-->
                                    <tr>
