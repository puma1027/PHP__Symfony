...
<!--{*
<<<<<<< HEAD
todo キー名が変更されてるので確認する 20200409 nakagawa
*}-->
                    <!--{if $arrErr.sql_name}--><span class="attention"><!--{$arrErr.sql_name}--></span><!--{/if}-->
                    <input type="text" name="sql_name" value="<!--{$arrForm.sql_name|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.sql_name != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60" />
<!--{*
=======
