...
<form name="form<!--{$smarty.section.cnt.iteration}-->" id="form<!--{$smarty.section.cnt.iteration}-->" method="post" action="<!--{$smarty.server.PHP_SELF|escape}-->">
	...
	<input type="hidden" name="type" value="<!--{$type|h}-->">
	                    ...
	                    <input type="hidden" name="reco" value="regist">
                        <table width="675">
                          <tr>
                            <th bgcolor="#FFFFFF">スタッフ<span class="red">*</span>
                            </th>
                            <td bgcolor="#FFFFFF">
                              <select name="staff_id">
                                <!--{html_options options=$arrStaffTEMPLATE selected=$arrComment[0].staff_id|escape}-->
                              </select>
                            </td>
                          </tr>
                          <tr>
                            <th bgcolor="#FFFFFF">コメント<span class="red">*</span>
                            </th>
                            <td bgcolor="#FFFFFF">
                              <textarea name="comment" cols="60" rows="8" class="area60" maxlength="<!--{$smarty.const.LLTEXT_LEN}-->" style="<!--{$arrErr.note|sfGetErrorColor}-->"><!--{$arrComment[0].best_products_recommend_comment_text|escape}--></textarea><br />
                              <!--{if $ERROR.comment}--><br><span class="red"><!--{$ERROR.comment}--></span><!--{/if}-->
                            </td>
                          </tr>
                          <tr>
                            <th bgcolor="#FFFFFF" >
                            ...
                            <td bgcolor="#FFFFFF" >
                              <input type="submit" name="subm" value="コメントを登録する" onclick="return lfnCheckSubmit(document.form<!--{$smarty.section.cnt.iteration}-->);"/>
                            </td>
                          </tr>
                        </table>
                        <!--{/if}-->
