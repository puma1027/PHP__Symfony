...
<ul class="level1">
    ...
    <!--{*Add KH 2014/3/11*}-->
    <li id="navi-total-order_analysis"			 
        class="<!--{if ($tpl_mainno == 'total' && $arrForm.page.value == 'order_analysis')}-->on<!--{/if}-->"
    ><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->total/<!--{$smarty.const.DIR_INDEX_PATH}-->order_analysis.php"><span>受注分析</span></a></li>
    <li id="navi-total-product_analysis"			
        class="<!--{if ($tpl_mainno == 'total' && $arrForm.page.value == 'product_analysis')}-->on<!--{/if}-->"
    ><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->total/<!--{$smarty.const.DIR_INDEX_PATH}-->product_analysis.php"><span>商品分析</span></a></li>
</ul>
