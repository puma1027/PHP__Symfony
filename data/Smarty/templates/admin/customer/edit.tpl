    ...
    <div id="customer" class="contents-main">
        <table class="form">
            ...
            <tr>
             ...
             <!--//{{KHS Add 2014.3.10-->
            <tr>
                <th>ワンピの魔法を知ったきっかけは？<span class="attention"> *</span></th>
                <td >
                <span class="attention"><!--{$arrErr.route_name}--><!--{$arrErr.other_route}--></span>きっかけ： 
                <select class="top" name="route_name" <!--{if $arrErr.route_name != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> >
                        <option value="" selected="selected">選択してください</option>
                        <!--{html_options options=$arrVisitRouteName selected=$arrForm.route_name}-->
                        </select><br />
                       その他： <input type="text" name="other_route" value="<!--{$arrForm.other_route|h}-->" size="30" class="box30" <!--{if $arrErr.other_route != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> />
                </td>
            </tr>
            <!--//}}KHS end 2014.3.10-->
...
<!--  KHS ADD 2014.3.19-->
            <!--{if $arrForm.mailmaga_flg  eq "" or $arrForm.mailmaga_flg eq 6 }-->
                        <!--{html_radios name="mailmaga_flg" options=$arrMailMagazineType separator=" " selected=3}-->
            <!--{else}-->
