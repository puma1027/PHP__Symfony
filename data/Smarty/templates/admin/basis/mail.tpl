...
<form name="form1" id="form1" method="post" action="?">
    ...
    <div id="basis" class="contents-main">
        <table>
            ...
            <tr>
                <th>メール本体</th>  <!-- ADD KGS_20140307 -->
                <td>
                <!--{assign var=key value="body"}-->  <!-- ADD KGS_20140307 -->
                <!--{if $arrErr[$key]}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <!--{/if}-->
                <textarea name="body" cols="75" rows="30" class="area75" onChange="setFlag();" style="height:500px;"<!--{$arrErr[$key]|sfGetErrorColor}-->"><!--{"\n"}--><!--{$arrForm[$key]|h}--></textarea><br />  <!-- ADD KGS_20140307 -->
                <span class="attention"> (上限<!--{$smarty.const.LLTEXT_LEN}-->文字)  <!-- ADD KGS_20140307 -->
                </span>
                <div>
                    <a class="btn-normal" href="javascript:;" onclick="eccube.countChars('form1','body','cnt_body'); return false;"><span>文字数カウント</span></a>  <!-- ADD KGS_20140307 -->
                    今までに入力したのは
                    <input type="text" name="cnt_body" size="4" class="box4" readonly="readonly" style="text-align:right" />  <!-- ADD KGS_20140307 -->
                </div>
                </td>
            </tr>
