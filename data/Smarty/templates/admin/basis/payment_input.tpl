...
<form name="form1" id="form1" method="post" action="./payment_input.php" enctype="multipart/form-data">
    ...
    <input type="hidden" name="payment_id" value="<!--{$tpl_payment_id|h}-->" /><!-- 2020.03.04 SG edit -->
    <input type="hidden" name="image_key" value="" />
    <input type="hidden" name="fix" value="<!--{$arrForm.fix.value|h}-->" /><!-- 2020.03.04 SG edit -->
    <!--{foreach key=key item=item from=$arrHidden}-->
    <input type="hidden" name="<!--{$key}-->" value="<!--{$item|h}-->" />
    <!--{/foreach}-->
    <input type="hidden" name="charge_flg" value="<!--{$charge_flg|h}-->" /><!-- 2020.03.04 SG edit -->
            ...
            <col width="80%" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!--{*assign var=key_from value="rule_max" todo プログラム確認しないとわからない20200409 nakagawa*}-->
