...
<!-- {{ ADD KGS_20140307 -->
	    <tr>
	    	<th>利用シーン | 会場<span class="attention"> *</span></th>
	        <td>
		        ...
		        <!--{html_options options=$arrUSESCENE selected=$arrForm[$key1]}-->
		        </select>
		        <select name="<!--{$key2}-->">
		        <option value="" selected="selected">選択してください</option>
		        <!--{html_options options=$arrUSESCENE selected=$arrForm[$key2]}-->
		        </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		        <select name="<!--{$key3}-->">
		        <option value="" selected="selected">選択してください</option>
		        <!--{html_options options=$arrVENUE selected=$arrForm[$key3]}-->
		        </select>
	        </td>
	    </tr>
<!-- }} ADD KGS_20140307 -->
