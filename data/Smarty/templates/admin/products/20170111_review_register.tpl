						...
						<table>
							...
							<tr>
								...
								<td>
                                    ...
                                    <a id="_add_product" class="btn-normal" href="javascript:;" name="change" onclick="fnAddProduct('<!--{$smarty.const.SITE_URL}-->admin/products/review_register.php?mode=add_product' );">レビュー商品の追加</a>
                                </td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
                                    ...
                                    <span class="attention"><!--{$arrErr.review_type}--></span>
                                    <span class="attention"><!--{$arrErr.review_size2}--></span><!--{*//::N00038 Add 20130418*}-->
                                    <span class="attention"><!--{$arrErr.review_etc}--></span>
                                    <span class="attention"><!--{$arrErr.review_age}--></span>

                                    身長<input type="text" name="review_height" value="<!--{$arrForm.review_height|escape}-->" size="6" class="box6" />cm
							...
							<tr>
								<th>着用感<span class="attention"> *</span></th>
                                <td align="left" >
...
<!-- 2013.03.01 RCHJ Add -->
                            <tr>
								<th>利用シーン<span class="attention"> *</span></th>
                                <td>
                                    ...
                                    <select name="<!--{$key3}-->">
                                    <option value="" selected="selected">選択してください</option>
                                    <!--{html_options options=$arrUSESCENE selected=$arrForm[$key3].value}-->
                                    </select>
                                </td>
                            </tr>
<!-- End -->
