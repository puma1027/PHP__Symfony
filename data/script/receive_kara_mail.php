...
require_once DATA_REALDIR . '/include/php_ini.inc';
require_once DATA_REALDIR . '/include/mobile.inc';
require_once DATA_REALDIR . '/lib/slib.php';
require_once DATA_REALDIR . '/class/SC_MobileKaraMail.php';
require_once DATA_REALDIR . '/class/SC_SendMail.php';
