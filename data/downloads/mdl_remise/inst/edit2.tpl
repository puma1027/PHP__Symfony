							...
							<tr>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr class="fs12n">
										...
										<td class="red10" bgcolor="#ffffff" width="527"><span class="red12"><!--{$arrErr.password}--></span><input type="password" name="password" value="<!--{$list_data.password|escape}-->" size="30" class="box30" <!--{if $arrErr.password != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> />　半角英数小文字<!--{$smarty.const.PASSWORD_MIN_LEN}-->〜<!--{$smarty.const.PASSWORD_MAX_LEN}-->文字（記号不可）</td>
									</tr>
									<tr>
									...
									<tr class="fs12n">
										...
										<td bgcolor="#ffffff" width="527"><span class="red12"><!--{$arrErr.mailmaga_flg}--></span>
											...
											<input type="radio" name="mailmaga_flg" value="3" <!--{if $arrErr.mailmaga_flg != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> <!--{if $list_data.mailmaga_flg eq "" or $list_data.mailmaga_flg eq 3 or $list_data.mailmaga_flg eq 6}-->checked<!--{/if}--> />希望しない</td>
                                                                        ...
                                                                        <!--{* remise決済モジュール用 *}-->
                                                                        <!--{assign var=path value="`$smarty.const.MODULE_PATH`"mdl_remise/include.php}-->
                                                                        <!--{if file_exists($path)}-->
                                                                            <tr class="fs12n">
                                                                                    <td bgcolor="#f2f1ec" width="190">カード情報の保持</td>
                                                                                    <td bgcolor="#ffffff" width="527"><!--{if $list_data.payquick_id == ""}-->なし<!--{else}-->あり　（登録日：<!--{$list_data.payquick_date}-->)<!--{/if}--></td>
                                                                            </tr>
                                                                        <!--{/if}-->
									<tr>
