...
**}-->
                            ...
                            <tr class="fs12n">
                                ...
                                <!--{* remise決済モジュール用 *}-->
                                <!--{if $arrForm.memo03.value == "mdl_remise" && $arrForm.memo01.value == $smarty.const.PAYMENT_CREDIT_ID}-->
                                    <input type="button" name="extsetcard" value="実売上/キャンセル" onclick="win01('<!--{$smarty.const.URL_DIR}-->user_data/remise_extset.php<!--{if $tpl_order_id}-->?order_id=<!--{$tpl_order_id}--><!--{/if}-->', 'payment_ext', '500', '500'); " />※ルミーズ決済用
                                <!--{/if}-->
                                </td>
                            </tr>
