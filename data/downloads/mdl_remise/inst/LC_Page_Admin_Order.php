...
/* remise決済モジュール用 */
if (file_exists(MODULE_PATH . 'mdl_remise/include.php') === TRUE) {
...
class LC_Page_Admin_Order extends LC_Page {
    ...
    function lfInitParam() {
        ...
        /* remise決済モジュール用 */
        $this->objFormParam->addParam("処理区分", "search_job", INT_LEN, "n", array("MAX_LENGTH_CHECK"));
    }
