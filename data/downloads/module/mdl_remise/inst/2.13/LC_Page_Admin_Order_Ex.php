        ...
        switch ($this->getMode()) {
            ...
            case 'search':
                ...
                if (count($this->arrErr) == 0) {
                    if ($_POST['all_disp'] == 'on') {
                        $where = 'del_flg = 0 or del_flg = 1';
                    } else {
                        $where = 'del_flg = 0';
                    }
                                    ...
                                    if ($element_ != "") {
                                        ...
                                        switch ($element_) {
                                            ...
                                            case "SALES_or_CAPTURE":
                                                $tmp_where_ .= "(memo06 = 'SALES' OR memo06 = 'CAPTURE') AND (memo10 != 'continue' OR memo10 is NULL)";
                                                break;
                                            case "AC_SALES":
                                                $tmp_where_ .= "(memo06 = 'SALES' OR memo06 = 'CAPTURE') AND memo10 = 'continue'";
                                                break;
                                            case "VOID_or_RETURN":
