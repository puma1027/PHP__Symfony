...
<section id="undercolumn">
    ...
    <form name="form1" id="form1" method="post" action="<!--{$smarty.const.ROOT_URLPATH}-->shopping/confirm.php">
                ...
                <div class="formBox">
                    ...
                    <div class="result_area">
                        <ul>
                            ...
                            <li>
                                <span class="mini">値引き（ポイントご使用時）： </span><!--{assign var=discount value=`$arrForm.use_point*$smarty.const.POINT_VALUE`}-->
        ...
        <!--{if $smarty.session.remise_credit && $smarty.session.twoclick}-->
            <!--★配送方法・お支払方法など★-->
            <section class="otherconfirm_area">
                <h3 class="subtitle">お支払い詳細入力</h3>

                <div class="form_area">
                    <!--▼フォームボックスここから -->
                    <div class="formBox">
                        <div class="innerBox">
                            <em>クレジットカードの支払い方法</em>：
                            ...
                            <!--{if $arrCreMet.value[$smarty.const.REMISE_PAYMENT_METHOD_DIVIDE] != "" || $arrCreMet.value[$smarty.const.REMISE_PAYMENT_METHOD_REVO] != ""}-->
                                ...
                                <!--{foreach key=index item=item from=$arrCreMet.value name=method_loop}-->
                                    <input type="radio" name="<!--{$key}-->" id="<!--{$index}-->" value="<!--{$index}-->" style="<!--{$arrErr.arrCreMet|sfGetErrorColor}-->" class="data-role-none"  />
                                    <label for="<!--{$index}-->"><!--{$item|escape}--></label><br />
                                <!--{/foreach}-->
                                <br />※クレジットカードの支払方法を選択してください。
                                <!--{if $arrCreMet.value[$smarty.const.REMISE_PAYMENT_METHOD_DIVIDE] != ""}-->
                                　　  <br />※分割払いの支払い回数は2回となります。
                                <!--{/if}-->
                            <!--{else}-->
                                ...
                                <label for="<!--{$smarty.const.REMISE_PAYMENT_METHOD_LUMP}-->"><!--{$arrCreMet.value[$smarty.const.REMISE_PAYMENT_METHOD_LUMP]|escape}-->
                                </label>
                            <!--{/if}--><br />
                        </div>
                    </div>
        ...
        <div class="btn_area">
            <ul class="btn_btm">
                ...
                <li>
                    <a rel="external" onclick="return fnCheckSubmit2();" href="javascript:void(document.form1.submit());" class="btn">かんたん決済で購入する</a>
                </li>
                <li>
                    <a rel="external" href="../cart/index.php" class="btn_back">戻る</a>
                </li>
                <!--{else if}-->
                    <!--{if $use_module}-->
                    <li>
                        <a rel="external" href="javascript:void(document.form1.submit());" class="btn">次へ</a>
                    </li>
                    <!--{else}-->
                    <li>
                        <a rel="external" href="javascript:void(document.form1.submit());" class="btn">ご注文完了ページへ</a>
                    </li>
                    <!--{/if}-->
                <li>
                    <a rel="external" href="./payment.php" class="btn_back">戻る</a>
                </li>
                <!--{/if}-->
            </ul>
        </div>
