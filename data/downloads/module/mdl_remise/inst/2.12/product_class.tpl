 ...
 *
 * Copyright(c) 2015 REMISE Corp. All Rights Reserved.
 *
 * http://www.remise.jp/
 *
...
//<![CDATA[
    $(function() {
        ...
        $('#copy_from_first').click(function() {
            ...
            var plg_remiseautocharge_total = $('#plg_remiseautocharge_total_0').val();
            $('input[id^=plg_remiseautocharge_total_]').val(plg_remiseautocharge_total);

            var plg_remiseautocharge_add_point = $('#plg_remiseautocharge_add_point_0').val();
            $('input[id^=plg_remiseautocharge_add_point_]').val(plg_remiseautocharge_add_point);

            var plg_remiseautocharge_first_interval_value = $('#plg_remiseautocharge_first_interval_0 option:selected').val();
            $('select[id^=plg_remiseautocharge_first_interval_]').each(function() {
                $(this).val(plg_remiseautocharge_first_interval_value);
            });

            var plg_remiseautocharge_next_date_value = $('#plg_remiseautocharge_next_date_0 option:selected').val();
            $('select[id^=plg_remiseautocharge_next_date_]').each(function() {
                $(this).val(plg_remiseautocharge_next_date_value);
            });

            var plg_remiseautocharge_interval_value = $('#plg_remiseautocharge_interval_0 option:selected').val();
            $('select[id^=plg_remiseautocharge_interval_]').each(function() {
                $(this).val(plg_remiseautocharge_interval_value);
            });

            var plg_remiseautocharge_refusal_not_allow_value = $('#plg_remiseautocharge_refusal_not_allow_0 option:selected').val();
            $('select[id^=plg_remiseautocharge_refusal_not_allow_]').each(function() {
                $(this).val(plg_remiseautocharge_refusal_not_allow_value);
            });
        });
    });
//]]>
