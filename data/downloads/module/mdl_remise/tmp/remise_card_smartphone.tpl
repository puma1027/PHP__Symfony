...
<form name="form1" id="form1" method="post" action="<!--{$arrForm.send_url.value|escape}-->">
    ...
    <div id="under02column">
        <div id="under02column_shopping">
            ...
            <!--{/if}-->
            <!--{* 20200625 ishibashi
            <table summary="お支払い詳細入力" class="delivname remise-sp-inputfield"  border="1">
                <colgroup width="20%"></colgroup>
                <colgroup width="80%"></colgroup>
                <tr>
                    <th>支払い方法</th>
            ...
            <!--{* 20200625 ishibashi 下記にnextボタン仕様のため一旦コメントアウトします。
       ...
       <div class="btn_area">
            <ul class="btn_btm">
                <!--{* 20200625 ishibashi 遷移されないため、下記に作成
                ...
                *}-->
                ...
                <li class="widebtnarea"><a href="#" class="btn btn--attention btn--large ui-link" onclick="fnCheckSubmit('next');return false;">次へ</a></li>
