...
<form name="form1" id="form1" method="post" action="?">
    ...
    <!--{foreach from=$arrForm.order_id item=order_id}-->
        ...
        <input type="hidden" name="etc2_data[<!--{$order_id|h}-->]" value="<!--{$arrForm.etc2_data[$order_id]|h}-->" />
    <!--{/foreach}-->
    ...
    <table class="form">
        ...
        <tr>
            ...
            <td>
                <!--{if $arrErr.year}--><span class="attention"><!--{$arrErr.year}--></span><!--{/if}-->
                <select name="year">
        ...
        <tr>
            <th>帳票の種類</th>
            <td>
                <!--{if $arrErr.download}--><span class="attention"><!--{$arrErr.download}--></span><!--{/if}-->
                <select name="type">
        ...
        <tr>
            <th>帳票メッセージ</th>
            <td>
                <!--{if $arrErr.msg1}--><span class="attention"><!--{$arrErr.msg1}--></span><!--{/if}-->
        ...
        <tr>
            ...
            <td>
                ...
                2行目：<input type="text" name="etc2_msg" size="40" value="<!--{$arrForm.etc2_msg|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->"/><br />
                <!--{if is_array($arrForm.etc2_data)}-->
                    <span style="font-size: 80%;">※[○年○月○日]に各注文の次回課金日が出力されます。</span><br />
                <!--{/if}-->
